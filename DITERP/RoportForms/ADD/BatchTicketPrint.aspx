<%@ Page Title="Batch Ticket Print" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="BatchTicketPrint.aspx.cs" ClientTarget="uplevel"
    Inherits="RoportForms_ADD_BatchTicketPrint" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Batch Ticket Print
                            </div>
                            <div class="tools">
