<%@ Page Title="Shade Print" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ShadePrint.aspx.cs" ClientTarget="uplevel" Inherits="RoportForms_ADD_ShadePrint" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Shade Print
                            </div>
                            <div class="tools">
