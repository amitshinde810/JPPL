<%@ Page Title="Customer Enquiry Print" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="CustomerEnquiryPrint.aspx.cs" ClientTarget="uplevel"
    Inherits="RoportForms_ADD_CustomerEnquiryPrint" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Customer Enquiry Print
                            </div>
                            <div class="tools">
