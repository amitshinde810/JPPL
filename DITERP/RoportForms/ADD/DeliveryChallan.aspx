<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="DeliveryChallan.aspx.cs"
    ClientTarget="uplevel" Inherits="RoportForms_ADD_DeliveryChallan" Title="Delivery Challan" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Delivery Challan Report
                            </div>
                            <div class="tools">
