<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="SubContractorPOPrint.aspx.cs"
    Inherits="RoportForms_ADD_SubContractorPOPrint" ClientTarget="uplevel" Title="Sub Contractor Purchase Order" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Sub Contractor Purchase Order Print
                            </div>
                            <div class="tools">
