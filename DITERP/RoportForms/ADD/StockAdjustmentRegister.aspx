<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="StockAdjustmentRegister.aspx.cs"
    ClientTarget="uplevel" Inherits="RoportForms_ADD_StockAdjustmentRegister" Title="Stock Adjustment Register" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Stock Adjustment Register
                            </div>
                            <div class="tools">
