<%@ Page Title="AMC Print" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="AMCPrint.aspx.cs" ClientTarget="uplevel" Inherits="RoportForms_ADD_AMCPrint" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Annual Maintenance Contract Print
                            </div>
                            <div class="tools">
