<%@ Page Title="Stock Ledger Register" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="StockLedgerTypeRegi.aspx.cs" ClientTarget="uplevel"
    Inherits="RoportForms_ADD_StockLedgerTypeRegi" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Stock ledger Type
                            </div>
                            <div class="tools">
