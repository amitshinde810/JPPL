<%@ Page Title="Shade Development Requisition Register" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="CustomerEnquiryRegister.aspx.cs" ClientTarget="uplevel"
    Inherits="RoportForms_ADD_CustomerEnquiryRegister" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Shade Development Requisition Register
                            </div>
                            <div class="tools">
