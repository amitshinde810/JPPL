<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="TaxInvoicePrint.aspx.cs"
    ClientTarget="uplevel" Inherits="RoportForms_ADD_TaxInvoicePrint" Title="Tax Invoice Print" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption" visible="false" runat="server" id="t1">
                                <i class="fa fa-reorder"></i>Tax Invoice Print
                            </div>
                            <div class="caption" visible="false" runat="server" id="t2">
