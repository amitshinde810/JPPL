<%@ Page Title="Store To Store Casting Print" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="StoreToStoreCastingPrint.aspx.cs" ClientTarget="uplevel"
    Inherits="RoportForms_ADD_StoreToStoreCastingPrint" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Store To Store Casting Print
                            </div>
                            <div class="tools">
