<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="DispToSubContPrint.aspx.cs"
    Inherits="RoportForms_ADD_DispToSubContPrint" ClientTarget="uplevel" Title="Dispatch to Sub Contractor Print" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Dispatch to Sub Contractor Print
                            </div>
                            <div class="tools">
