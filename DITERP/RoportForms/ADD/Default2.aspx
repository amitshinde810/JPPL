<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Default2.aspx.cs" Inherits="RoportForms_ADD_Default2" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Tax Invoice QR
                            </div>
                            <div class="tools">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                       <%-- <center>
                                        ...
                                        <asp:Image ID="imgQR" runat="server" style="height:500px;width:500px"/>
                                    </div>
                                </div>
                            </div>
                        </div>
