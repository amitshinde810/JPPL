<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" ClientTarget="uplevel"
    CodeFile="LabourChargeInvoicePrint.aspx.cs" Inherits="RoportForms_ADD_LabourChargeInvoicePrint"
    Title="Labour Charge Invoice Print" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Labour Charge Invoice Print
                            </div>
                            <div class="tools">
