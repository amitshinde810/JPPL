<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="CustomerPORPTForm.aspx.cs"
    ClientTarget="uplevel" Inherits="RoportForms_ADD_CustomerPORPTForm" Title="Sale Order" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Sale Order Report
                            </div>
                            <div class="tools">
