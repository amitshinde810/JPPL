<%@ Page Title="Purchase Requisition Print" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="PurchaseRequisitionPrint.aspx.cs" ClientTarget="uplevel"
    Inherits="RoportForms_ADD_PurchaseRequisitionPrint" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Purchase Requisition Print
                            </div>
                            <div class="tools">
