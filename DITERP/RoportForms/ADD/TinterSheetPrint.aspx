<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="TinterSheetPrint.aspx.cs"
    ClientTarget="uplevel" Inherits="RoportForms_ADD_dsTinterSheetPrint" Title="Tinter Sheet Print" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Tinter Sheet Print
                            </div>
                            <div class="tools">
