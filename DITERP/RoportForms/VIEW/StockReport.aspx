<%@ Page Title="Stock Report" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="StockReport.aspx.cs" Inherits="RoportForms_VIEW_StockReport" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Store Wise Stock Report
                            </div>
                            <div class="tools">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel8">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlStore" runat="server" placeholder="Select Store Name" AutoPostBack="True"
                                                            CssClass="select2" Width="100%" TabIndex="2" OnSelectedIndexChanged="ddlStore_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
