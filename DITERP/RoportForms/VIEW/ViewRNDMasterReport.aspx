<%@ Page Title="Master Report" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewRNDMasterReport.aspx.cs" Inherits="RoportForms_VIEW_ViewRNDMasterReport" %>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlMasterForms" runat="server" MsgObrigatorio=" Report" placeholder="Select Master Form"
                                                            ...
                                                            <asp:ListItem Value="5">Process Master</asp:ListItem>
                                                            <asp:ListItem Value="6">Shade Master</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
