<%@ Page Title="Inhouse Vendor Stock" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="StockReportInHouseVendor.aspx.cs" Inherits="RoportForms_VIEW_StockReportInHouseVendor" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Inhouse Vendor Stock
                            </div>
                            <div class="tools">
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel10">
                                                    <ContentTemplate>
                                                        <asp:RadioButtonList ID="rbtType" runat="server" AutoPostBack="True" TabIndex="1"
                                                            RepeatDirection="Horizontal" Visible="false" CssClass="checker" OnSelectedIndexChanged="rbtType_SelectedIndexChanged">
                                                            <asp:ListItem Value="0" Selected="True">Date Wise &nbsp&nbsp</asp:ListItem>
