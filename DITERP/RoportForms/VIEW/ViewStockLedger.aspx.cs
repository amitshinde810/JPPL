...
public partial class RoportForms_VIEW_ViewStockLedger : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                str1 = "Detail";
                Response.Redirect("~/RoportForms/ADD/StockLedger.aspx?Title=" + Title + "&Date_All=" + chkDateAll.Checked.ToString() + "&Comp_All=" + chkAllComp.Checked.ToString() + "&FromDate=" + From + "&ToDate=" + To + "&Item_Code=" + i_code + "&detail=" + str1 + "&categoryAll=" + chkAllCategory.Checked.ToString() + "&category=" + ddlItemCategory.SelectedValue.ToString() + "&plantCode=" + rbplant.SelectedValue.ToString() + "&PDF=false", false);
            }
            if (rbtType.SelectedValue == "1")
            {
                ...
                Response.Redirect("~/RoportForms/ADD/StockLedgerRegister.aspx?Title=" + Title + "&Date_All=" + chkDateAll.Checked.ToString() + "&Comp_All=" + chkAllComp.Checked.ToString() + "&FromDate=" + From + "&ToDate=" + To + "&Item_Code=" + ddlComponent.SelectedValue.ToString() + "&detail=" + str1 + "&categoryAll=" + chkAllCategory.Checked.ToString() + "&category=" + ddlItemCategory.SelectedValue.ToString() + "&WithAmt=" + ChkWithAmt + "&plantCode=" + rbplant.SelectedValue.ToString() + "&PDF=false", false);
            }
            if (rbtType.SelectedValue == "2")
            {
                str1 = "MIS";
                if (rbplant.SelectedValue == "-2147483648")
                {
                    ChkWithAmt = "WithAmt";
                }
                else if (rbplant.SelectedValue == "-2147483647")
                {
                    ChkWithAmt = "rbplant";
                }
                Response.Redirect("~/RoportForms/ADD/StockLedgerRegister.aspx?Title=" + Title + "&Date_All=" + chkDateAll.Checked.ToString() + "&Comp_All=" + chkAllComp.Checked.ToString() + "&FromDate=" + From + "&ToDate=" + To + "&Item_Code=" + ddlComponent.SelectedValue.ToString() + "&detail=" + str1 + "&categoryAll=" + chkAllCategory.Checked.ToString() + "&category=" + ddlItemCategory.SelectedValue.ToString() + "&WithAmt=" + ChkWithAmt + "&plantCode=" + rbplant.SelectedValue.ToString() + "", false);
            }

            if (rbtType.SelectedValue == "3")
            {
                str1 = "STORE";
            ...
            if (rbtType.SelectedValue == "3A")
            {
                str1 = "STORE";
                ChkWithAmt = "WithAmtPlant2";
                Response.Redirect("~/RoportForms/ADD/StockLedgerRegister.aspx?Title=" + Title + "&Date_All=" + chkDateAll.Checked.ToString() + "&Comp_All=" + chkAllComp.Checked.ToString() + "&FromDate=" + From + "&ToDate=" + To + "&Item_Code=" + ddlComponent.SelectedValue.ToString() + "&detail=" + str1 + "&categoryAll=" + chkAllCategory.Checked.ToString() + "&category=" + ddlItemCategory.SelectedValue.ToString() + "&WithAmt=" + ChkWithAmt + "", false);
            }
            if (rbtType.SelectedValue == "4")
            {
                str1 = "STORE";
                ChkWithAmt = "WithoutAmt";
                Response.Redirect("~/RoportForms/ADD/StockLedgerRegister.aspx?Title=" + Title + "&Date_All=" + chkDateAll.Checked.ToString() + "&Comp_All=" + chkAllComp.Checked.ToString() + "&FromDate=" + From + "&ToDate=" + To + "&Item_Code=" + ddlComponent.SelectedValue.ToString() + "&detail=" + str1 + "&categoryAll=" + chkAllCategory.Checked.ToString() + "&category=" + ddlItemCategory.SelectedValue.ToString() + "&WithAmt=" + ChkWithAmt + "", false);
            }
            if (rbtType.SelectedValue == "4A")
            {
                str1 = "STORE";
                ChkWithAmt = "WithoutAmtplant2";
                Response.Redirect("~/RoportForms/ADD/StockLedgerRegister.aspx?Title=" + Title + "&Date_All=" + chkDateAll.Checked.ToString() + "&Comp_All=" + chkAllComp.Checked.ToString() + "&FromDate=" + From + "&ToDate=" + To + "&Item_Code=" + ddlComponent.SelectedValue.ToString() + "&detail=" + str1 + "&categoryAll=" + chkAllCategory.Checked.ToString() + "&category=" + ddlItemCategory.SelectedValue.ToString() + "&WithAmt=" + ChkWithAmt + "", false);
            }
            if (rbtType.SelectedValue == "5")
            {
                str1 = "StdVSActual";
                if (rbtWithAmt.SelectedIndex == 0)
                {
    ...
    protected void btnExportToPDF_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                str1 = "Detail";
                Response.Redirect("~/RoportForms/ADD/StockLedger.aspx?Title=" + Title + "&Date_All=" + chkDateAll.Checked.ToString() + "&Comp_All=" + chkAllComp.Checked.ToString() + "&FromDate=" + From + "&ToDate=" + To + "&Item_Code=" + i_code + "&detail=" + str1 + "&categoryAll=" + chkAllCategory.Checked.ToString() + "&category=" + ddlItemCategory.SelectedValue.ToString() + "&plantCode=" + rbplant.SelectedValue.ToString() + "&PDF=true", false);
            }
            if (rbtType.SelectedValue == "1")
            {
                str1 = "Summary";
                ...
                Response.Redirect("~/RoportForms/ADD/StockLedgerRegister.aspx?Title=" + Title + "&Date_All=" + chkDateAll.Checked.ToString() + "&Comp_All=" + chkAllComp.Checked.ToString() + "&FromDate=" + From + "&ToDate=" + To + "&Item_Code=" + ddlComponent.SelectedValue.ToString() + "&detail=" + str1 + "&categoryAll=" + chkAllCategory.Checked.ToString() + "&category=" + ddlItemCategory.SelectedValue.ToString() + "&WithAmt=" + ChkWithAmt + "&plantCode=" + rbplant.SelectedValue.ToString() + "&PDF=true", false);
            }
            //if (rbtType.SelectedValue == "2")
            //{
            //    str1 = "MIS";
