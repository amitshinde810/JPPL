<%@ Page Title="Purchase Schedule Register" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewPurchaseScheduleRegister.aspx.cs" Inherits="IRN_VIEW_PurchaseScheduleRegister" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Purchase Schedule Register
                            </div>
                            <div class="tools">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel5">
                                                    <ContentTemplate>
                                                        <div class="input-group">
                                                            <asp:TextBox ID="txtFromDate" runat="server" AutoPostBack="true" OnTextChanged="txtFromDate_OnTextChanged"
                                                                placeholder="dd MMM yyyy" CssClass="form-control" MsgObrigatorio="Please Select From Date"
                                            ...
                                            <div class="col-md-3">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel4">
                                                    <ContentTemplate>
                                                        <div class="input-group">
                                                            <asp:TextBox ID="txtToDate" runat="server" AutoPostBack="true" OnTextChanged="txtToDate_OnTextChanged"
                                                                placeholder="dd MMM yyyy" CssClass="form-control" MsgObrigatorio="Please Select To Date"
                                                                Visible="false" TabIndex="7" ValidationGroup="Save"></asp:TextBox>
                                            ...
                                            <div class="col-md-1">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="chkDateAll" runat="server" Visible="false" Checked="false" CssClass="checker"
                                                            Text="&nbspAll" AutoPostBack="True" TabIndex="8" OnCheckedChanged="chkDateAll_CheckedChanged" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel7">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlType" runat="server" AutoPostBack="True" CssClass="select2"
                                                            Width="100%" MsgObrigatorio="Type" TabIndex="11" OnSelectedIndexChanged="ddlType_SelectedIndexChanged">
                                                            <asp:ListItem Text="Supplier" Value="0" />
                                                            <asp:ListItem Text="Sub-Contractor" Value="1" />
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                            <div class="col-md-1">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel10">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="TypeAll" runat="server" CssClass="checker" Text="&nbspAll" AutoPostBack="True"
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel8">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlItemCode" runat="server" AutoPostBack="True" CssClass="select2"
                                                            Width="100%" MsgObrigatorio="Item Code" TabIndex="9" OnSelectedIndexChanged="ddlItemCode_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel11">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlFinishedComponent" runat="server" AutoPostBack="True" CssClass="select2"
                                                            Width="100%" MsgObrigatorio="Item Name" TabIndex="9" OnSelectedIndexChanged="ddlFinishedComponent_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="chkAllItem" EventName="CheckedChanged" />
