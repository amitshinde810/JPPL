<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewExiseTariffMaster.aspx.cs" Inherits="RoportForms_VIEW_ViewExiseTariffMaster" %>
                ...
                <div class="col-md-8">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Exise Tariff Master
                            </div>
                            <div class="tools">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlExiseTariffNo" runat="server" placeholder="Select Exise Tariff No"
                                                            AutoPostBack="True" CssClass="select2_category form-control" TabIndex="2">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="ChkExiseTariffNoAll" EventName="CheckedChanged" />
                                                    </Triggers>
                                                </asp:UpdatePanel>
                                            </div>
                                            <div class="col-md-2">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel4">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="ChkExiseTariffNoAll" runat="server" CssClass="checker" Text="All"
                                                            AutoPostBack="True" TabIndex="3" OnCheckedChanged="ChkExiseTariffNoAll_CheckedChanged" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
