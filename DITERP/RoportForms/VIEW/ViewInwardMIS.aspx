<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewInwardMIS.aspx.cs"
    Inherits="RoportForms_VIEW_ViewInwardMIS" Title="Material Inward MIS" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Material Inward MIS
                            </div>
                            <div class="tools">
                                                    ...
                                                    <ContentTemplate>
                                                        <div class="input-group">
                                                            <asp:TextBox ID="txtFromDate" runat="server" placeholder="dd MMM yyyy" CssClass="form-control"
                                                                runat="server" TabIndex="6" ValidationGroup="Save" MsgObrigatorio="From Date"
                                                    ...
                                                    <ContentTemplate>
                                                        <div class="input-group">
                                                            <asp:TextBox ID="txtToDate" runat="server" placeholder="dd MMM yyyy" CssClass="form-control"
                                                                AutoPostBack="true" runat="server" TabIndex="7" ValidationGroup="Save" MsgObrigatorio="To Date"
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel13">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlInwardType" runat="server" AutoPostBack="True" CssClass="select2"
                                                            Width="100%" TabIndex="13" OnSelectedIndexChanged="ddlInwardType_SelectedIndexChanged">
                                                            <asp:ListItem Value="IWIM" Selected="True">&nbsp;Raw Material Inward&nbsp;&nbsp;&nbsp;</asp:ListItem>
                                                            <asp:ListItem Value="OUTCUSTINV">&nbsp;SubContractor Inward&nbsp;&nbsp;&nbsp;</asp:ListItem>
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlCustomerName" runat="server" AutoPostBack="True" CssClass="select2"
                                                            Width="100%" MsgObrigatorio="Supplier" TabIndex="11" OnSelectedIndexChanged="ddlCustomerName_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel8">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlItemCode" runat="server" CssClass="select2" Width="100%"
                                                            MsgObrigatorio="Item" TabIndex="9" AutoPostBack="true" OnSelectedIndexChanged="ddlItemCode_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel11">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlFinishedComponent" runat="server" CssClass="select2" Width="100%"
                                                            MsgObrigatorio="Item" TabIndex="9" AutoPostBack="true" OnSelectedIndexChanged="ddlFinishedComponent_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="chkAllItem" EventName="CheckedChanged" />
