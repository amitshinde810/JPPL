<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewTrayDCRegister.aspx.cs"
    Inherits="RoportForms_VIEW_ViewTrayDCRegister" Title="Tray Stock Report" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Tray Stock Report
                            </div>
                            <div class="tools">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel15">
                                                        <ContentTemplate>
                                                            <asp:RadioButtonList ID="rbtCustVend" runat="server" AutoPostBack="True" TabIndex="1"
                                                                RepeatDirection="Horizontal" CssClass="checker" Visible="true" OnSelectedIndexChanged="rbtCustVend_SelectedIndexChanged">
                                                                <asp:ListItem Value="0">&nbsp;Customer &nbsp&nbsp</asp:ListItem>
                                                                <asp:ListItem Value="1">&nbsp;Vendor &nbsp&nbsp</asp:ListItem>
                                                            </asp:RadioButtonList>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                                    ...
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel6">
                                                        <ContentTemplate>
                                                            <asp:RadioButtonList ID="rbtTransType" runat="server" AutoPostBack="True" TabIndex="1"
                                                                ...
                                                                <asp:ListItem Value="0">&nbsp;Customer &nbsp&nbsp</asp:ListItem>
                                                                <asp:ListItem Value="1" Selected="True">&nbsp;Vendor &nbsp&nbsp</asp:ListItem>
                                                            </asp:RadioButtonList>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                                    ...
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel14">
                                                        <ContentTemplate>
                                                            <asp:RadioButtonList ID="rbtWithAmt" Visible="false" runat="server" AutoPostBack="True"
                                                                ...
                                                                <asp:ListItem Value="0">&nbsp;With Value&nbsp;&nbsp;</asp:ListItem>
