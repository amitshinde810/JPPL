<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="TrayStockReport.aspx.cs"
    Inherits="RoportForms_VIEW_TrayStockReport" Title="Tray Stock MIS Report" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Tray Stock MIS Report
                            </div>
                            <div class="tools">
