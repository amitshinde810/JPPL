<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewInwardReports.aspx.cs"
    Inherits="RoportForms_VIEW_ViewInwardReports" Title="Inward Reports" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Inward Reports
                            </div>
                            <div class="tools">
