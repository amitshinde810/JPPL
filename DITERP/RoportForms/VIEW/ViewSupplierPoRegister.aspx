<%@ Page Title="Purchase Order Register" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewSupplierPoRegister.aspx.cs" Inherits="RoportForms_VIEW_ViewSupplierPoRegister" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    ...
    <script type="text/javascript">
        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function(evt, args) {
            jQuery("#<%=ddlPoFor.ClientID %>").select2();
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Purchase Order Register
                            </div>
                            <div class="tools">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel10">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlPoFor" runat="server" AutoPostBack="True" CssClass="select2"
                                                            Width="100%" MsgObrigatorio="Supplier Name" TabIndex="11" OnSelectedIndexChanged="ddlPoFor_SelectedIndexChanged">
                                                            <asp:ListItem Value="0" Selected="True">&nbsp;Supplier Purchase Order&nbsp;&nbsp;&nbsp;</asp:ListItem>
                                                            <asp:ListItem Value="1">&nbsp;SubContractor Purchase Order&nbsp;&nbsp;&nbsp;</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="chkPoFOr" EventName="CheckedChanged" />
                                                    </Triggers>
                                                </asp:UpdatePanel>
                                            </div>
                                            <div class="col-md-1">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel13">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="chkPoFOr" runat="server" CssClass="checker" Text="&nbspAll" AutoPostBack="True"
                                                            TabIndex="12" OnCheckedChanged="chkPoFOr_CheckedChanged" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-8">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                    ...
                                                    <Triggers>
                                                        ...
                                                        <asp:AsyncPostBackTrigger ControlID="ddlPoFor" EventName="SelectedIndexChanged" />
                                                    </Triggers>
                                                </asp:UpdatePanel>
                                            </div>
                                            <div class="col-md-1">
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlPOType" CssClass="select2" Width="100%" runat="server" MsgObrigatorio="Please Select PO Type "
                                                            TabIndex="1" AutoPostBack="true" OnSelectedIndexChanged="ddlPOType_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
