<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="VIewExciseRegister.aspx.cs"
    Inherits="RoportForms_VIEW_VIewExciseRegister" Title="Excise Register" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Excise Register
                            </div>
                            <div class="tools">
                            ...
                            <div class="form-horizontal">
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel13">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlUser" runat="server" AutoPostBack="True" CssClass="select2_category form-control"
                                                            ...
                                                            <asp:ListItem Value="2">PLA</asp:ListItem>
                                                    ...
                                                    <ContentTemplate>
                                                        <div class="input-group">
                                                            <asp:TextBox ID="txtFromDate" runat="server" placeholder="dd MMM yyyy" CssClass="form-control"
                                                                TabIndex="2" ValidationGroup="Save"></asp:TextBox>
                                ...
                                <div class="form-actions fluid">
                                    <div class="col-md-offset-4 col-md-9">
                                        ...
                                        <asp:LinkButton ID="btnExport" CssClass="btn green" TabIndex="5" runat="server" OnClientClick="return VerificaCamposObrigatorios();"
