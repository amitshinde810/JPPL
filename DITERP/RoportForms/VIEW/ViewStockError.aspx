<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewStockError.aspx.cs"
    Inherits="RoportForms_VIEW_ViewStockError" Title="Stock Error Correction " %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Stock Error Correction
                            </div>
                            <div class="tools">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel13">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlstore" runat="server" AutoPostBack="True" CssClass="select2"
                                            ...
                                            <div class="col-md-2">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel14">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="chkAllStore" runat="server" CssClass="checker" Text="All" AutoPostBack="True"
                                                            TabIndex="14" OnCheckedChanged="chkAllStore_CheckedChanged" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
