<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewBillOfComponentRegister.aspx.cs"
    Inherits="RoportForms_VIEW_ViewBillOfComponentRegister" Title="Vill Of Component Register" %>
                ...
                <div class="col-md-8">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Bill Of Component Register
                            </div>
                            <div class="tools">
