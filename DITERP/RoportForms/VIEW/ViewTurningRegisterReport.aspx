<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewTurningRegisterReport.aspx.cs"
    Inherits="RoportForms_VIEW_ViewTurningRegisterReport" Title="Turning Register" %>
                                                    ...
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel6">
                                                        <ContentTemplate>
                                                            <asp:RadioButtonList ID="rbtGroup" runat="server" AutoPostBack="True" TabIndex="1"
                                                                ...
                                                                <asp:ListItem Value="1">&nbsp;Sub Contractor Wise</asp:ListItem>
                                                            </asp:RadioButtonList>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel11">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlSubContracter" Width="100%" placeholder="Select Sub Cont"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                        <ContentTemplate>
                                                            <asp:RadioButtonList ID="rbLstType" runat="server" AutoPostBack="True" TabIndex="1"
                                                                RepeatDirection="Horizontal" CssClass="checker" CellPadding="10">
