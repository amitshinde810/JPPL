<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="DCReturnRegister.aspx.cs"
    Inherits="RoportForms_VIEW_DCReturnRegister" Title="Delivery Challan Return Register" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Delivery Challan Return Register
                            </div>
                            <div class="tools">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlCustomerName" runat="server" AutoPostBack="True"  CssClass="select2" Width="100%"
                                                            TabIndex="11">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel11">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlFinishedComponent" runat="server" AutoPostBack="True" CssClass="select2" Width="100%"
                                                            TabIndex="9">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
