<%@ Page Title="Material Requisition - MIS Report" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewMaterialRequisition_MIS.aspx.cs" Inherits="RoportForms_VIEW_ViewMaterialRequisition_MIS" %>
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel7">
                                                    <ContentTemplate>
                                                        <asp:RadioButtonList ID="rbtType" runat="server" AutoPostBack="True" TabIndex="1"
                                                            RepeatDirection="Horizontal" CssClass="checker" CellPadding="10" OnSelectedIndexChanged="rbtType_SelectedIndexChanged">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel11">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlFinishedComponent" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlFinishedComponent_SelectedIndexChanged"
                                                            CssClass="select2_category form-control" TabIndex="9">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel9">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="ChkProductionNoAll" runat="server" CssClass="checker" Text="All"
                                                            Checked="true" AutoPostBack="True" TabIndex="3" OnCheckedChanged="ChkProductionNoAll_CheckedChanged" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
