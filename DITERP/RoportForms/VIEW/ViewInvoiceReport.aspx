<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewInvoiceReport.aspx.cs"
    Inherits="RoportForms_VIEW_ViewInvoiceReport" Title="Invoice Report" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Invoice Reports
                            </div>
                            <div class="tools">
