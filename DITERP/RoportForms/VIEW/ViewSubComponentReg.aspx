...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    ...
    <script type="text/javascript">
        ...
        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function(evt, args) {
            jQuery("#<%=ddlSubComponent.ClientID %>").select2();
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlSCCodeNo" runat="server" placeholder="Finish Product Code"
                                                            AutoPostBack="True" MsgObrigatorio="Finish Product Code" CssClass="select2" Width="100%"
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlSubComponent" runat="server" placeholder=" Finish Product Name"
                                                            AutoPostBack="True" MsgObrigatorio="Finish Product Name" CssClass="select2" Width="100%"
