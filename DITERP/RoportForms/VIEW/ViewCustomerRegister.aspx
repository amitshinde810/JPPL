<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewCustomerRegister.aspx.cs"
    Inherits="RoportForms_VIEW_ViewCustomerRegister" Title="Customer Master Register" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Customer Master Register
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="chkAll" runat="server" CssClass="checker" Text="&nbsp&nbspAll"
                                                            AutoPostBack="True" TabIndex="3" OnCheckedChanged="chkAll_CheckedChanged" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                            ...
                            <div class="form-actions fluid">
                                <div class="col-md-offset-4 col-md-9">
                                    ...
                                    <asp:LinkButton ID="btnCancel" CssClass="btn default" OnClick="btnCancel_Click" TabIndex="4"
