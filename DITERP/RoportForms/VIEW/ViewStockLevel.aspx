<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewStockLevel.aspx.cs"
    Inherits="RoportForms_VIEW_ViewStockLevel" Title="Stock Level Report" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Stock Level Report
                            </div>
                            <div class="tools">
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel10">
                                                    <ContentTemplate>
                                                        <asp:RadioButtonList ID="rbtType" runat="server" AutoPostBack="True" TabIndex="1"
                                                            ...
                                                            <asp:ListItem Value="0" Selected="True">Minimum &nbsp&nbsp</asp:ListItem>
                                                            <asp:ListItem Value="1">Maximum &nbsp&nbsp</asp:ListItem>
                                                        </asp:RadioButtonList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
