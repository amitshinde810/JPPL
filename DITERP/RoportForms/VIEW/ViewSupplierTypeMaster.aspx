<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewSupplierTypeMaster.aspx.cs" Inherits="RoportForms_VIEW_ViewSupplierTypeMaster" %>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlSupplierCode" runat="server" placeholder="Sector" AutoPostBack="True"
                                                            CssClass="select2_category form-control" TabIndex="2" OnSelectedIndexChanged="ddlSupplierCode_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                            ...
                                            <div class="col-md-2">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel4">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="chkAllSupplier" OnCheckedChanged="chkAllSupplier_CheckedChanged"
                                                            runat="server" CssClass="checker" Text="All" AutoPostBack="True" TabIndex="3" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                                                    ...
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlSupplierName" runat="server" placeholder="Select  Supplier  Name"
                                                                AutoPostBack="True" CssClass="select2_category form-control" TabIndex="2" OnSelectedIndexChanged="ddlSupplierName_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="chkAll" EventName="CheckedChanged" />
