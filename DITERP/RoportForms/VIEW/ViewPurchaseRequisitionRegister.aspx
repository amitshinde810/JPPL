<%@ Page Title="Purchase Requisition Register" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewPurchaseRequisitionRegister.aspx.cs" Inherits="RoportForms_VIEW_PurchaseRequisitionRegister" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Purchase Requisition Register
                            </div>
                            <div class="tools">
