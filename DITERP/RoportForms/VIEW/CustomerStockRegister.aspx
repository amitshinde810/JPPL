<%@ Page Title="Customer Stock" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="CustomerStockRegister.aspx.cs" Inherits="RoportForms_VIEW_CustomerStockRegister" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Customer Stock Report
                            </div>
                            <div class="tools">
