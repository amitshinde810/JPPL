<%@ Page Title="Issue To Production Register" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewIssueToProductionRegister.aspx.cs" Inherits="RoportForms_VIEW_ViewIssueToProductionRegister" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Issue To Production Register
                            </div>
                            <div class="tools">
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel7">
                                                    <ContentTemplate>
                                                        <asp:RadioButtonList ID="rbtType" runat="server" AutoPostBack="True" TabIndex="1"
                                                            Visible="false" RepeatDirection="Horizontal" CssClass="checker" CellPadding="10"
                                                            OnSelectedIndexChanged="rbtType_SelectedIndexChanged">
                                                            <asp:ListItem Value="0" Selected="True">&nbsp;Direct</asp:ListItem>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel13">
                                                    <ContentTemplate>
                                                        <asp:RadioButtonList ID="rbPrintType" runat="server" AutoPostBack="True" TabIndex="1"
                                        ...
                                        <div class="form-group">
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel14">
                                                    <ContentTemplate>
                                                        <div class="input-group">
                                                            <asp:TextBox ID="txtFromDate1" runat="server" placeholder="dd MMM yyyy" AutoPostBack="true"
                                                                OnTextChanged="txtFromDate_TextChanged" CssClass="form-control" TabIndex="6"
                                                                ValidationGroup="Save"></asp:TextBox>
                                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                            <cc1:CalendarExtender ID="CalendarExtender2" BehaviorID="calendar1" runat="server"
                                                                Enabled="True" TargetControlID="txtFromDate1" PopupButtonID="txtFromDate1" Format="dd MMM yyyy">
                                                            </cc1:CalendarExtender>
                                                        </div>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="chkDateAll1" EventName="CheckedChanged" />
                                                    </Triggers>
                                                </asp:UpdatePanel>
                                            </div>
                                            <label class="col-md-2 control-label text-right">
                                            ...
                                            <div class="col-md-3">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel15">
                                                    <ContentTemplate>
                                                        <div class="input-group">
                                                            <asp:TextBox ID="txtToDate1" runat="server" AutoPostBack="true" OnTextChanged="txtFromDate_TextChanged"
                                                                placeholder="dd MMM yyyy" CssClass="form-control" TabIndex="7" ValidationGroup="Save"></asp:TextBox>
                                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                            <cc1:CalendarExtender ID="CalendarExtender3" BehaviorID="calendar2" runat="server"
                                                                Enabled="True" TargetControlID="txtToDate1" PopupButtonID="txtToDate1" Format="dd MMM yyyy">
                                                            </cc1:CalendarExtender>
                                                        </div>
                                                    </ContentTemplate>
                                                    <Triggers>
                                            ...
                                            <div class="col-md-1">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel16">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="chkDateAll1" runat="server" CssClass="checker" Text="&nbspAll"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel9">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlDepartment" runat="server" AutoPostBack="True" CssClass="select2"
                                                            Width="700px" TabIndex="9">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel10">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="chkAlldept" runat="server" CssClass="checker" Text="All" AutoPostBack="True"
                                                            TabIndex="10" OnCheckedChanged="chkAlldept_CheckedChanged" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
