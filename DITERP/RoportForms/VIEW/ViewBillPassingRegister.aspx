<%@ Page Title="Bill Passing Register" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewBillPassingRegister.aspx.cs" Inherits="RoportForms_VIEW_BillPassingRegister" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Bill Passing Register
                            </div>
                            <div class="tools">
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel6">
                                                    <ContentTemplate>
                                                        <asp:RadioButtonList ID="rbtGroup" runat="server" AutoPostBack="True" TabIndex="1"
                                                            ...
                                                            <asp:ListItem Value="0" Selected="True">&nbsp&nbsp&nbsp&nbsp Datewise&nbsp&nbsp&nbsp&nbsp</asp:ListItem>
                                                            <asp:ListItem Value="1">&nbsp&nbsp&nbsp&nbsp Supplierwise</asp:ListItem>
                                                        </asp:RadioButtonList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlCustomerName" runat="server" AutoPostBack="True" CssClass="select2_category form-control"
                                                            MsgObrigatorio="Please Select Supplier" TabIndex="11">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
