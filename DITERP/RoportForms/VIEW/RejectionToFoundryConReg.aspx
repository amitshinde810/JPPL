<%@ Page Title="Casting Conversion Register" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="RejectionToFoundryConReg.aspx.cs" Inherits="Transactions_VIEW_RejectionToFoundryConReg" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Casting Conversion Register
                            </div>
                            <div class="tools">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel13">
                                                    <ContentTemplate>
                                                        <asp:RadioButtonList Visible="false" ID="rbPrintType" runat="server" AutoPostBack="True"
                                                            TabIndex="1" RepeatDirection="Horizontal" CssClass="checker" CellPadding="10">
