<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewSalesMISWeightWise.aspx.cs"
    Inherits="RoportForms_VIEW_ViewSalesMISWeightWise" Title="Internal Standard Weight Vs Customer Weight Vs Actual weight MIS" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Weight Wise MIS Report
                            </div>
                            <div class="tools">
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlCustomerName" runat="server" Width="100%" AutoPostBack="True"
                                                            CssClass="select2" TabIndex="11" OnSelectedIndexChanged="ddlCustomerName_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel13">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlItemCode" OnSelectedIndexChanged="ddlItemCode_SelectedIndexChanged"
                                                            runat="server" AutoPostBack="True" Width="100%" CssClass="select2" TabIndex="9">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel8">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddltype" runat="server" Width="100%" AutoPostBack="True" CssClass="select2"
                                                            ...
                                                            <asp:ListItem Value="0">&nbsp;All Tax Invoice</asp:ListItem>
                                                            <asp:ListItem Value="1">&nbsp;Supplementary invoice Only</asp:ListItem>
                                                            <asp:ListItem Value="2" Selected="True">&nbsp;Tax Invoice Only</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="chkAllItem" EventName="CheckedChanged" />
