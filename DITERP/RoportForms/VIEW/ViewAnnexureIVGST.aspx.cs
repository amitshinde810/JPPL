...
public partial class RoportForms_VIEW_ViewAnnexureIVGST : System.Web.UI.Page
{
    #region Variable
    static string right = "";
    string From = "";
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Redirect("~/RoportForms/ADD/AnnexureIVGST.aspx?Title=" + Title + "&Condition=" + strCondition + "&FromDate=" + From + "&ToDate=" + To + "&Party=" + ddlCustomerName.SelectedValue + "", false);
        }
        catch (Exception Ex)
        {
