<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewTaxInvoiceRegister.aspx.cs"
    Inherits="RoportForms_VIEW_ViewTaxInvoiceRegister" Title="Tax Invoice Register" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Tax Invoice Register
                            </div>
                            <div class="tools">
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel6">
                                                    <ContentTemplate>
                                                        <asp:RadioButtonList ID="rbtGroup" runat="server" AutoPostBack="True" TabIndex="1"
                                                            ...
                                                            <asp:ListItem Value="3">&nbsp;HSNNumberwise</asp:ListItem>
                                                        </asp:RadioButtonList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel8">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddltype" runat="server" Width="100%" AutoPostBack="True" CssClass="select2"
                                                            TabIndex="9">
                                                            <asp:ListItem Value="0" Selected="True">&nbsp;All Tax Invoice</asp:ListItem>
                                                            <asp:ListItem Value="1">&nbsp;Supplementary invoice Only</asp:ListItem>
                                                            <asp:ListItem Value="2">&nbsp;Tax Invoice Only</asp:ListItem>
                                                            <asp:ListItem Value="3">&nbsp;Labour Charge Invoice Only</asp:ListItem>
                                                            <asp:ListItem Value="4">&nbsp;Amortation Invoice Only</asp:ListItem>
                                                            <asp:ListItem Value="5">&nbsp;PDC Only</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="chkAllItem" EventName="CheckedChanged" />
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel10">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="chkType" runat="server" CssClass="checker" Text="&nbspAll" AutoPostBack="True"
                                                            TabIndex="10" Visible="false" OnCheckedChanged="chkType_CheckedChanged" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                                ...
                                <div class="form-actions fluid">
                                    <div class="col-md-offset-4 col-md-9">
                                        ...
                                        <asp:LinkButton ID="btnExport" CssClass="btn green" TabIndex="15" runat="server"
                                            OnClientClick="return VerificaCamposObrigatorios();" OnClick="btnExport_Click"><i class="fa fa-check-square"> </i>  Export </asp:LinkButton>
                                    </div>
                                </div>
                            </div>
                        </div>
