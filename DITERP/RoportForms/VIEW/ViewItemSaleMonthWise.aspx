                                        ...
                                        <div class="form-group">
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel6">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlItemName" runat="server" placeholder="Select Item Name"
                                                            AutoPostBack="True" CssClass="select2" Width="500px" TabIndex="2" OnSelectedIndexChanged="ddlItemName_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                            ...
                                            <div class="col-md-2">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel7">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="chkAllItemName" runat="server" CssClass="checker" Text="All" AutoPostBack="True"
                                                            Visible="false" TabIndex="3" OnCheckedChanged="chkAllItemName_CheckedChanged" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
