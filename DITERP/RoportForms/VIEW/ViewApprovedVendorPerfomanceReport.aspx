<%@ Page Title="Approved Vendor Performance Report" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewApprovedVendorPerfomanceReport.aspx.cs"
    Inherits="RoportForms_VIEW_ViewApprovedVendorPerfomanceReport" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Approved Vendor Performance Report
                            </div>
                            <div class="tools">
                                                    ...
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel4">
                                                        <ContentTemplate>
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                                <cc1:CalendarExtender ID="CalendarExtender1df" runat="server" Enabled="True" TargetControlID="txtTodate"
                                                                    Format="dd MMM yyyy">
                                                                </cc1:CalendarExtender>
                                                            </div>
                                                        </ContentTemplate>
