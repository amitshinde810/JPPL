<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewBillOfMaterialRegister.aspx.cs"
    Inherits="RoportForms_VIEW_ViewBiilOfMaterialRegister" Title="Bill Of Material Register" %>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <label class="col-md-3 control-label text-right">
                                                Finished Product Item Code
                                            </label>
                                            <div class="col-md-6">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlItemCode" runat="server" placeholder="Select Finished Component"
                                                            AutoPostBack="True" CssClass="select2" TabIndex="2" Width="100%" OnSelectedIndexChanged="ddlItemCode_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlFinishedComponent" runat="server" placeholder="Select Finished Component"
                                                            AutoPostBack="True" CssClass="select2" Width="100%" TabIndex="2" OnSelectedIndexChanged="ddlFinishedComponent_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="chkAll" EventName="CheckedChanged" />
