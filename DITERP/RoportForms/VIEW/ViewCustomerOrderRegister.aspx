                                                    ...
                                                    <ContentTemplate>
                                                        <div class="input-group">
                                                            <asp:TextBox ID="txtFromDate" runat="server" AutoPostBack="true" OnTextChanged="txtFromDate_TextChanged"
                                                                placeholder="dd MMM yyyy" CssClass="form-control" TabIndex="6" ValidationGroup="Save"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlCustomerName" runat="server" OnSelectedIndexChanged="ddlCustomerName_SelectedIndexChanged"
                                                            AutoPostBack="True" CssClass="select2_category form-control" TabIndex="11">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
