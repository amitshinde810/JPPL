<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewAnnexureIVGST.aspx.cs"
    Inherits="RoportForms_VIEW_ViewAnnexureIVGST" Title="Annexure IV GST" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Annexure IV GST
                            </div>
                            <div class="tools">
