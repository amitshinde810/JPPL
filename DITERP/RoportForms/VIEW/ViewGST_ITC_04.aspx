<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewGST_ITC_04.aspx.cs"
    Inherits="RoportForms_VIEW_ViewGST_ITC_04" Title="GST_ITC_04" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>GST ITC-04
                            </div>
                            <div class="tools">
                                                    ...
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel6">
                                                        <ContentTemplate>
                                                            <asp:RadioButtonList ID="rbtTransType" runat="server" AutoPostBack="True" TabIndex="1"
                                                                ...
                                                                onselectedindexchanged="rbtTransType_SelectedIndexChanged">
                                                                <asp:ListItem Value="0">Outward &nbsp&nbsp</asp:ListItem>
                                                                <asp:ListItem Value="1" Selected="True">Inward &nbsp&nbsp</asp:ListItem>
                                                                <asp:ListItem Value="2"  >Age wise pending challans &nbsp&nbsp</asp:ListItem>
                                                            </asp:RadioButtonList>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                                                        <ContentTemplate>
                                                         ...
                                                         <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="rbtTransType" EventName="SelectedIndexChanged" />
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlCustomerName" runat="server" placeholder="Select  Sub Contractor "
