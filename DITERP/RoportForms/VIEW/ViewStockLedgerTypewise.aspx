<%@ Page Title="Stock Ledger Register" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewStockLedgerTypewise.aspx.cs" Inherits="RoportForms_VIEW_ViewStockLedgerTypewise" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Stock Ledger Register
                            </div>
                            <div class="tools">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel6">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlitemtype" runat="server" placeholder="select Type" AutoPostBack="True"
                                                            CssClass="select2_category form-control" TabIndex="2" OnSelectedIndexChanged="ddlitemtype_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="Chkitem" EventName="CheckedChanged" />
                                                    </Triggers>
                                                </asp:UpdatePanel>
                                            </div>
                                            <div class="col-md-2">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel7">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="Chkitem" runat="server" CssClass="checker" Text="All" AutoPostBack="True"
                                                            TabIndex="3" OnCheckedChanged="Chkitem_CheckedChanged" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlComponent" runat="server" placeholder="Select Component"
                                            ...
                                            <div class="col-md-2">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="chkAllComp" runat="server" CssClass="checker" Text="All" AutoPostBack="True"
