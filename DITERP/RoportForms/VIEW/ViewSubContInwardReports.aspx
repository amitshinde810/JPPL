<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewSubContInwardReports.aspx.cs"
    Inherits="RoportForms_VIEW_ViewSubContInwardReports" Title="Sub Contractor Inward Report" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Sub Contractor Inward Reports
                            </div>
                            <div class="tools">
