<%@ Page Title="Overall Performance Of Supplier" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="OverallPerfView.aspx.cs" Inherits="RoportForms_VIEW_OverallPerfView" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Overall Performance Of Supplier
                            </div>
                            <div class="tools">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlCategory" runat="server" AutoPostBack="True" CssClass="select2"
                                                            Width="100%" MsgObrigatorio="Supplier Name" TabIndex="11">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                            ...
                                            <div class="col-md-1">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="chkSupplier" runat="server" CssClass="checker" Text="All" AutoPostBack="True"
                                                            TabIndex="12" OnCheckedChanged="chkSupplier_CheckedChanged" Visible="true" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
