<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewCountryMaster.aspx.cs"
    Inherits="Admin_View_ViewCountryMaster" Title="Country Master" %>
                    ...
                    <div class="col-md-7">
                        <div class="portlet box green">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-reorder"></i>Country Master
                                </div>
                                <div class="tools">
                            ...
                            <div class="portlet-body">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel100" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:GridView ID="dgCountryMaster" runat="server" Width="100%" AutoGenerateColumns="False"
                                            CellPadding="4" Font-Size="12px" ShowFooter="false" Font-Names="Verdana" GridLines="Both"
                                            CssClass="table table-striped table-bordered table-advance table-hover" DataKeyNames="COUNTRY_CODE"
                                            OnRowDeleting="dgCountryMaster_RowDeleting" OnRowEditing="dgCountryMaster_RowEditing"
                                            OnPageIndexChanging="dgCountryMaster_PageIndexChanging" OnRowCommand="dgCountryMaster_RowCommand "
                                            OnRowUpdating="dgCountryMaster_RowUpdating" AllowPaging="true" PageSize="15"
                                            on>
                                            <Columns>
                                                                ...
                                                                <ul class="dropdown-menu" role="menu">
                                                                    <li>
                                                                        <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                            Text="" CommandArgument='<%# Bind("COUNTRY_CODE") %>'><i class="fa fa-search"></i> View</asp:LinkButton>
                                                                    </li>
                                                                    <li>
                                                                        <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                            Text="" CommandArgument='<%# Bind("COUNTRY_CODE") %>'><i class="fa fa-edit"></i> Modify</asp:LinkButton>
                                                                    </li>
                                                                    <li>
                                                ...
                                                <asp:TemplateField HeaderText="SCT_CODE" SortExpression="SCT_CODE" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCOUNTRY_CODE" runat="server" Text='<%# Bind("COUNTRY_CODE") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Country Name" SortExpression="COUNTRY_NAME" HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCOUNTRY_NAME" CssClass="" runat="server" Text='<%# Eval("COUNTRY_NAME") %>'></asp:Label>
                                                    </ItemTemplate>
