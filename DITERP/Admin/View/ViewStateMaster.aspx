<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewStateMaster.aspx.cs"
    Inherits="Masters_VIEW_ViewStateMaster" Title="State Master" %>
                ...
                <div class="col-md-7">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>State Master
                            </div>
                            <div class="tools">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="dgState" runat="server" Width="100%" AutoGenerateColumns="False"
                                        CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="SM_CODE" Font-Names="Verdana"
                                        ...
                                        OnRowCommand="dgState_RowCommand" OnRowUpdating="dgState_RowUpdating">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="SM_CODE" SortExpression="SM_CODE" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSM_CODE" runat="server" Text='<%# Bind("SM_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Country" SortExpression="SM_CODE" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCOUNTRY_NAME" runat="server" Text='<%# Eval("COUNTRY_NAME") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="State" SortExpression="SM_CODE" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSTATE_NAME" runat="server" Text='<%# Eval("SM_NAME") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                        </Columns>
