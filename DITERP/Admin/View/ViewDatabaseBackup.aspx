<%@ Page Title="Datatbase Backup" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewDatabaseBackup.aspx.cs" Inherits="Admin_View_ViewDatabaseBackup" %>
                ...
                <div class="col-md-8">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Database Backup
                            </div>
                            <div class="tools">
                            ...
                            <div class="form-actions fluid">
                                <div class="col-md-offset-4 col-md-9">
                                    <asp:LinkButton ID="btnSubmit" CssClass="btn green" TabIndex="3" runat="server" OnClick="btnSubmit_Click"
                                        OnClientClick="return VerificaCamposObrigatorios();"><i class="fa fa-check-square"> </i>  Process </asp:LinkButton>
