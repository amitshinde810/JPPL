<%@ Page Title="Tally Master" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="TallyMaster.aspx.cs" Inherits="Admin_Add_TallyMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtTallyName" placeholder="Tally Name"
                                                    TabIndex="1" runat="server" MaxLength="50" MsgObrigatorio="Tally Name"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        function VerificaCamposObrigatorios() {
            try {
                if (VerificaObrigatorio('#<%=txtTallyName.ClientID%>', '#Avisos') == false) {
                    $("#Avisos").fadeOut(6000);
                    return false;
                }
                else {
