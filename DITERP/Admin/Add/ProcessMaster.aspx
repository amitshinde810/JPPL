<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ProcessMaster.aspx.cs"
    Inherits="Admin_Add_ProcessMaster" Title="Process Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label text-right">
                                                <span class="required">*</span> Process Name
                                            </label>
                                            <div class="col-md-8">
                                                <asp:TextBox CssClass="form-control " ID="txtProcessName" placeholder="Process Name"
    ...
    <script type="text/javascript">
        function VerificaCamposObrigatorios() {
            try {
                if (VerificaObrigatorio('#<%=txtProcessName.ClientID%>', '#Avisos') == false) {
