<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="StateMaster.aspx.cs"
    Inherits="Masters_ADD_StateMaster" Title="State Master" %>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <label class="col-md-3 control-label text-right">
                                                <span class="required">*</span> State Name
                                            </label>
                                            <div class="col-md-5">
                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox CssClass="form-control " ID="txtStateName" placeholder="State Name"
                                                            TabIndex="2" runat="server" MsgObrigatorio="State Name"></asp:TextBox>
                                                    </ContentTemplate>
                                                    <Triggers>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox CssClass="form-control " ID="txtStateCode" placeholder="State Code"
                                                            TabIndex="2" runat="server" MsgObrigatorio="State Code"></asp:TextBox>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="ddlCountry" EventName="SelectedIndexChanged" />
                                                    </Triggers>
    ...
    <script type="text/javascript">
        function VerificaCamposObrigatorios() {
            try {
                ...
                if (VerificaObrigatorio('#<%=txtStateName.ClientID%>', '#Avisos') == false) {
