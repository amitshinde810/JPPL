<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="CountryMaster.aspx.cs"
    Inherits="Admin_Add_CountryMaster" Title="Country Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtCountryName" placeholder="Country Name"
                                                    TabIndex="1" runat="server" MaxLength="50" MsgObrigatorio="Country Name"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        function VerificaCamposObrigatorios() {
            try {
                if (VerificaObrigatorio('#<%=txtCountryName.ClientID%>', '#Avisos') == false) {
