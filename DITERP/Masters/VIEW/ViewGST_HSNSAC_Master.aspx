                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:GridView ID="dgExciseTariffDetails" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="HSN/SAC No." SortExpression="E_TARIFF_NO" HeaderStyle-HorizontalAlign="Left"
                                            ...
                                            <asp:TemplateField HeaderText="CGST" SortExpression="E_BASIC" HeaderStyle-HorizontalAlign="Right">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="SGST" SortExpression="E_EDU_CESS" HeaderStyle-HorizontalAlign="Right">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="IGST" SortExpression="E_H_EDU" HeaderStyle-HorizontalAlign="Right">
                                                <ItemTemplate>
