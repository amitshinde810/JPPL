<%@ Page Title="Supplier Master" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewSupplierMaster.aspx.cs" Inherits="Masters_VIEW_ViewSupplierMaster" %>
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="dgCustomerMaster" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Supplier ID" SortExpression="P_PARTY_CODE" HeaderStyle-HorizontalAlign="Left"
                                                Visible="false">
                                                <ItemTemplate>
