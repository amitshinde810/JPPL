<%@ Page Title="Supplier Category Master" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewSupplierCategoryMaster.aspx.cs" Inherits="Masters_VIEW_ViewSupplierCategoryMaster" %>
                ...
                <div class="col-md-8">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Supplier Category Master
                            </div>
                            <div class="tools">
                            ...
                            <asp:UpdatePanel runat="server" ID="upnlGridView">
                                <ContentTemplate>
                                    <asp:GridView ID="dgSuppCategory" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        GridLines="Both" DataKeyNames="SCM_CODE" CssClass="table table-striped table-bordered table-advance table-hover"
                                        ...
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <asp:LinkButton ID="lnkView" BorderStyle="None" runat="server" CausesValidation="False"
                                                                        CommandName="View" Text="" CommandArgument='<%# Bind("SCM_CODE") %>'>
                                                                ...
                                                                <li>
                                                                    <asp:LinkButton ID="lnkModify" BorderStyle="None" runat="server" CausesValidation="False"
                                                                        CommandName="Modify" Text="" CommandArgument='<%# Bind("SCM_CODE") %>'>
                                            ...
                                            <asp:TemplateField HeaderText="Store Code" SortExpression="SCM_CODE" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSCM_CODE" CssClass="formlabel" runat="server" Text='<%# Bind("SCM_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Category Name" SortExpression="SCM_NAME" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSCM_NAME" CssClass="formlabelUpper" runat="server" Text='<%# Eval("SCM_NAME") %>'></asp:Label>
                                                </ItemTemplate>
