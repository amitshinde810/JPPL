<%@ Page Title="Item Standard Production" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ItemStandWgtMaster.aspx.cs" Inherits="Masters_VIEW_ItemStandWgtMaster" %>
                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="dgRawMaterial" runat="server" Width="100%" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Line" SortExpression="LM_NAME" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblLM_NAME" CssClass="" runat="server" Text='<%# Eval("LM_NAME") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Stage" SortExpression="STG_NAME">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblSTG_NAME" CssClass="Control-label" runat="server" Text='<%# Eval("STG_NAME") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Standard Production" SortExpression="I_STANDARD_PRODUCTION"
                                                            HeaderStyle-HorizontalAlign="Right">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblStandardWeight" CssClass="Control-label pull-right" runat="server"
                                                                    Text='<%# Eval("I_STANDARD_PRODUCTION") %>'></asp:Label>
                                                            </ItemTemplate>
