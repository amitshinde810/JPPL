                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="dgExciseTariffDetails" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Tariff No." SortExpression="E_TARIFF_NO" HeaderStyle-HorizontalAlign="Left"
                                            ...
                                            <asp:TemplateField HeaderText="Special Excise Duty" SortExpression="E_SPECIAL" Visible="false"
                                            ...
                                            <asp:TemplateField HeaderText="Educational Cess" SortExpression="E_EDU_CESS" Visible="false"
                                                HeaderStyle-HorizontalAlign="Right">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Higher Education Cess" SortExpression="E_H_EDU" Visible="false"
                                                HeaderStyle-HorizontalAlign="Right">
                                                <ItemTemplate>
