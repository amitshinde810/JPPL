<%@ Page Title="Item Transfer Master" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewItemTransferMaster.aspx.cs" Inherits="Masters_VIEW_ViewItemTransferMaster" %>
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="dgBillofMaterial" runat="server" Width="100%" AutoGenerateColumns="False"
                                        CellPadding="4" Font-Size="12px" ShowFooter="false" Font-Names="Verdana" GridLines="Both"
                                        CssClass="table table-striped table-bordered table-advance table-hover" DataKeyNames="TM_CODE"
                                        OnRowDeleting="dgBillofMaterial_RowDeleting" OnRowEditing="dgBillofMaterial_RowEditing"
                                        OnPageIndexChanging="dgBillofMaterial_PageIndexChanging" OnRowCommand="dgBillofMaterial_RowCommand"
                                        OnRowUpdating="dgBillofMaterial_RowUpdating" AllowPaging="true" PageSize="15">
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                        Text="View" CommandArgument='<%# Bind("TM_CODE") %>'><i class="fa fa-search"></i> View</asp:LinkButton>
                                                                </li>
                                                                <li>
                                                                    <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                        Text="Modify" CommandArgument='<%# Bind("TM_CODE") %>'><i class="fa fa-edit"></i> Modify</asp:LinkButton>
                                                                </li>
                                                                <li>
                                            ...
                                            <asp:TemplateField HeaderText="TM_CODE" SortExpression="TM_CODE" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTM_CODE" runat="server" Text='<%# Bind("TM_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
