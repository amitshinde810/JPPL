<%@ Page Title="Store Master" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="StoreMaster.aspx.cs" Inherits="Masters_VIEW_StoreMaster" %>
                ...
                <div class="col-md-8">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Store Master
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            ...
                            <asp:UpdatePanel runat="server" ID="upnlGridView">
                                <ContentTemplate>
                                    <asp:GridView ID="dgStore" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        GridLines="Both" DataKeyNames="STORE_CODE" CssClass="table table-striped table-bordered table-advance table-hover"
                                        ShowFooter="false" OnRowDeleting="dgStore_RowDeleting" OnRowEditing="dgStore_RowEditing"
                                        OnPageIndexChanging="dgStore_PageIndexChanging" OnRowCommand="dgStore_RowCommand"
                                        ...
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <asp:LinkButton ID="lnkView" BorderStyle="None" runat="server" CausesValidation="False"
                                                                        CommandName="View" Text="" CommandArgument='<%# Bind("STORE_CODE") %>'>
                                                                ...
                                                                <li>
                                                                    <asp:LinkButton ID="lnkModify" BorderStyle="None" runat="server" CausesValidation="False"
                                                                        CommandName="Modify" Text="" CommandArgument='<%# Bind("STORE_CODE") %>'>
                                            ...
                                            <asp:TemplateField HeaderText="Store Code" SortExpression="STORE_CODE" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSTORE_CODE" CssClass="formlabel" runat="server" Text='<%# Bind("STORE_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Store Name" SortExpression="STORE_NAME" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSTORE_NAME" CssClass="formlabelUpper" runat="server" Text='<%# Eval("STORE_NAME") %>'></asp:Label>
                                                </ItemTemplate>
