<%@ Page Title="Item Category" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewItemCategoryMaster.aspx.cs" Inherits="Masters_VIEW_ViewItemCategoryMaster" %>
                                ...
                                <div class="col-md-12">
                                    <div style="overflow-x: auto;">
                                        <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                            <ContentTemplate>
                                                <asp:GridView ID="dgItemCategory" runat="server" Width="100%" AutoGenerateColumns="False"
                                                    CellPadding="4" Font-Size="12px" ShowFooter="false" Font-Names="Verdana" GridLines="Both"
                                                    CssClass="table table-striped table-bordered table-advance table-hover" DataKeyNames="I_CAT_CODE"
                                                    OnRowDeleting="dgItemCategory_RowDeleting" OnRowEditing="dgItemCategory_RowEditing"
                                                    OnPageIndexChanging="dgItemCategory_PageIndexChanging" OnRowCommand="dgItemCategory_RowCommand"
                                                    OnRowUpdating="dgItemCategory_RowUpdating" AllowPaging="true" PageSize="15">
                                                    <Columns>
                                                                        ...
                                                                        <ul class="dropdown-menu" role="menu">
                                                                            <li>
                                                                                <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                                    Text="" CommandArgument='<%# Bind("I_CAT_CODE") %>'><i class="fa fa-search"></i> View</asp:LinkButton>
                                                                            </li>
                                                                            <li>
                                                                                <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                                    Text="" CommandArgument='<%# Bind("I_CAT_CODE") %>'><i class="fa fa-edit"></i> Modify</asp:LinkButton>
                                                                            </li>
                                                                            <li>
                                                        ...
                                                        <asp:TemplateField HeaderText="I_CAT_CODE" SortExpression="I_CAT_CODE" Visible="false">
                                                            <ItemTemplate>
