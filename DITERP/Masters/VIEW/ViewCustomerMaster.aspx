<%@ Page Title="Customer Master" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewCustomerMaster.aspx.cs" Inherits="Masters_VIEW_ViewCustomerMaster" %>
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="dgCustomerMaster" runat="server" Width="100%" AutoGenerateColumns="False"
                                        CellPadding="4" Font-Size="12px" ShowFooter="false" Font-Names="Verdana" GridLines="Both"
                                        CssClass="table table-striped table-bordered table-advance table-hover" DataKeyNames="P_CODE"
                                        OnRowDeleting="dgCustomerMaster_RowDeleting" OnRowEditing="dgCustomerMaster_RowEditing"
                                        OnPageIndexChanging="dgCustomerMaster_PageIndexChanging" OnRowCommand="dgCustomerMaster_RowCommand"
                                        OnRowUpdating="dgCustomerMaster_RowUpdating" AllowPaging="true" PageSize="25">
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                        Text="View" CommandArgument='<%# Bind("P_CODE") %>'><i class="fa fa-search"></i> View</asp:LinkButton>
                                                                </li>
                                                                <li>
                                            ...
                                            <asp:TemplateField HeaderText="Customer ID" SortExpression="P_PARTY_CODE" HeaderStyle-HorizontalAlign="Left"
                                                Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblP_PARTY_CODE" CssClass="" runat="server" Text='<%# Eval("P_PARTY_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Contact Person" SortExpression="P_CONTACT" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblP_CONTACT" CssClass="" runat="server" Text='<%# Eval("P_CONTACT") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Phone No." SortExpression="P_PHONE" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblP_PHONE" CssClass="" runat="server" Text='<%# Eval("P_PHONE") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Area" SortExpression="A_NO" HeaderStyle-HorizontalAlign="Left"
                                                Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblA_NO" CssClass="" runat="server" Text='<%# Eval("A_NO") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                        </Columns>
