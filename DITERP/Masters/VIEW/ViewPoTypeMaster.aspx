<%@ Page Title="PO Type Master" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewPoTypeMaster.aspx.cs" Inherits="Masters_VIEW_ViewPoTypeMaster" %>
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <asp:UpdatePanel runat="server" ID="upnlGridView">
                                <ContentTemplate>
                                    <asp:GridView ID="dgPoTypeMaster" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        GridLines="Both" DataKeyNames="PO_T_CODE" CssClass="table table-striped table-bordered table-advance table-hover"
                                        ...
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                        Text="" CommandArgument='<%# Bind("PO_T_CODE") %>'>
                                            ...
                                            <asp:TemplateField HeaderText="Po Type Code" SortExpression="PO_T_CODE" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPO_T_CODE" CssClass="formlabel" runat="server" Text='<%# Bind("PO_T_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Short Name" SortExpression="PO_T_SHORT_NAME" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPO_T_SHORT_NAME" CssClass="formlabelUpper" runat="server" Text='<%# Eval("PO_T_SHORT_NAME") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Description" SortExpression="PO_T_DESC" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPO_T_DESC" CssClass="formlabelUpper" runat="server" Text='<%# Eval("PO_T_DESC") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="First Letter" SortExpression="PO_T_FIRST_LETTER" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPO_T_FIRST_LETTER" CssClass="formlabelUpper" runat="server" Text='<%# Eval("PO_T_FIRST_LETTER") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                            </asp:TemplateField>
                                        </Columns>
