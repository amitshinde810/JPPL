                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel ID="UpdatePanel11" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:CheckBox ID="chkDevelopment" runat="server" Text="&nbspPDC Part" CssClass="checker"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel ID="UpdatePanel21" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right" MaxLength="10" ID="txtAs_Cast_Weight"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-2 control-label label-sm">
                                                    <span class="required"></span>Part Photo
                                                </label>
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                                        <ContentTemplate>
                                                            <asp:FileUpload ID="FileUpload1" TabIndex="5" ClientIDMode="Static" onchange="this.form.submit()"
                                                                runat="server" />
                                                            <asp:Button ID="btnUpload2" Text="Upload2" runat="server" OnClick="Upload2" Style="display: none" />
                                                            <asp:LinkButton ID="lnkupload2" runat="server" Text="" OnClick="lnkupload2_Click"> </asp:LinkButton>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
                    ...
                    <asp:UpdatePanel runat="server" ID="UpdatePanel39">
                        <ContentTemplate>
                            ...
                            <cc1:ModalPopupExtender runat="server" ID="ModalPopupExtenderDovView" BackgroundCssClass="modalBackground"
                                ...
                                PopupControlID="PanelDoc" TargetControlID="LinkButton2">
                            </cc1:ModalPopupExtender>
                                    ...
                                    <div class="portlet-body form">
                                        <div class="form-horizontal">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <iframe runat="server" id="myframe" width="600px" height="400px"></iframe>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-offset-5 col-md-9">
    ...
    <script type="text/javascript">
        function VerificaCamposObrigatorios() {
            try {
                ...
                if (VerificaObrigatorio('#<%=txtItemCode.ClientID%>', '#Avisos') == false) {
                    $("#Avisos").fadeOut(6000); return false;
                }
                ...
                else if (VerificaValorCombo('#<%=ddlSAC.ClientID%>', '#Avisos') == false) {
                    $("#Avisos").fadeOut(6000); return false;
                }
                else
                { return true; }
