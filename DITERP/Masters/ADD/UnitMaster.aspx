<%@ Page Title="Unit Master" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="UnitMaster.aspx.cs" Inherits="Masters_ADD_UnitMaster" %>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <label class="col-md-3 control-label text-right">
                                                <span class="required">*</span> Unit Short Name
                                            </label>
                                            <div class="col-md-5">
                                                <asp:TextBox CssClass="form-control " ID="txtUnitName" placeholder="Unit Short Name"
                                                    TabIndex="1" runat="server" MsgObrigatorio="Unit Short Name"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <label class="col-md-3 control-label text-right">
                                                <span class="required">*</span> Unit Description
                                            </label>
                                            <div class="col-md-5">
                                                <asp:TextBox CssClass="form-control " ID="txtUnitDesc" placeholder="Unit Description"
                                                    TabIndex="2" runat="server" MsgObrigatorio="Unit Description"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
