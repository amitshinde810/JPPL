<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="SupplierCategoryMaster.aspx.cs"
    Inherits="Admin_Add_SupplierCategoryMaster" Title="Supplier Category Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:TextBox CssClass="form-control " ID="txtCategoryName" placeholder="Category Name"
                                                    TabIndex="1" runat="server" MaxLength="200" MsgObrigatorio="Category Name"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        function VerificaCamposObrigatorios() {
            try {
                if (VerificaObrigatorio('#<%=txtCategoryName.ClientID%>', '#Avisos') == false) {
