                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <asp:TextBox CssClass="form-control " ID="txtCommodity" placeholder="Commodity" TabIndex="2"
                                                            runat="server" MaxLength="2000" MsgObrigatorio="Commodity"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                            <ContentTemplate>
                                                                <asp:DropDownList ID="ddlTallyBasic" CssClass="select2_category form-control input-sm"
                                                                    AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlTallyBasic_SelectedIndexChanged"
                                                                    MsgObrigatorio="Tally Name For Central Tax" TabIndex="4">
                                                                </asp:DropDownList>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                                    </div>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                            <ContentTemplate>
                                                                <asp:DropDownList ID="ddlTallySpecial" CssClass="select2_category form-control input-sm"
                                                                    AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlTallySpecial_SelectedIndexChanged"
                                                                    MsgObrigatorio="Tally Name For Cess" TabIndex="6">
                                                                </asp:DropDownList>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                                    </div>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                            <ContentTemplate>
                                                                <asp:DropDownList ID="ddlTallyEdu" CssClass="select2_category form-control input-sm"
                                                                    AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlTallyEdu_SelectedIndexChanged"
                                                                    MsgObrigatorio="Tally Name For State/Union Territory Tax" TabIndex="8">
                                                                </asp:DropDownList>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                                    </div>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                            <ContentTemplate>
                                                                <asp:DropDownList ID="ddlTallySHEdu" CssClass="select2_category form-control input-sm"
                                                                    AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlTallySHEdu_SelectedIndexChanged"
                                                                    MsgObrigatorio="Tally Name For Integrated Tax" TabIndex="10">
                                                                </asp:DropDownList>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                                    </div>
