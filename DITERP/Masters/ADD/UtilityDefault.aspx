<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="UtilityDefault.aspx.cs"
    Inherits="Masters_UtilityDefault" Title="DITERP | Utilitty" %>
                    ...
                    <div class="row">
                        <div class="col-md-4 sidebar-content ">
                            <ul class="ver-inline-menu tabbable margin-bottom-25">
                                ...
                                <li id="vcnUtility" runat="server"><a id="A3" href="#" onserverclick="btnVCM_click"
                                    runat="server"><i class="fa fa-tasks"></i>Create VCM</a> </li>
                                ...
                                <li id="suppUpload" visible="true" runat="server"><a id="A6" href="#" onserverclick="btnsuppUpload_click"
                                    runat="server"><i class="fa fa-tasks"></i>Supplementary Invoice Upload</a>    </li>
                                     <li id="EInvoice" visible="true" runat="server"><a id="A7" href="#" onserverclick="EInvoice_click"
                                    runat="server"><i class="fa fa-tasks"></i>E Invoice Upload</a>
                                </li>
                            </ul>
                        </div>
                    </div>
