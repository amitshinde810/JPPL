                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlSItemCodeno" DataTextField="I_CODENO"
                                                                DataValueField="I_CODE" CssClass="select2" Width="100%" runat="server" MsgObrigatorio="Finished Product Code"
                                                                TabIndex="1" AutoPostBack="True" OnSelectedIndexChanged="ddlSItemCodeno_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:DropDownList ID="ddlMaterialFrom" CssClass="select2" Width="100%" runat="server"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox AutoPostBack="true" MaxLength="10" CssClass="form-control text-right input-sm"
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <label class="control-label label-sm ">
                                                    <font color="red">*</font>Scrap Qty</label>
