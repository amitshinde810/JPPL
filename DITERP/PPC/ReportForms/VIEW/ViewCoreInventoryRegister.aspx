<%@ Page Title="Core Inventory Register" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewCoreInventoryRegister.aspx.cs" Inherits="PPC_VIEW_ViewCoreInventoryRegister" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Core Inventory Register
                            </div>
                            <div class="tools">
