<%@ Page Title="Castings requried from machine shop Report" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewCastingsrequriedformmachineshopReport.aspx.cs"
    Inherits="PPC_ReportForms_VIEW_ViewCastingsrequriedformmachineshopReport" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Castings requried from machine shop Report
                            </div>
                            <div class="tools">
