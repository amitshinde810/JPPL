<%@ Page Title="Tentative Monthly Customer Schedule Report" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewCustomerSchedule.aspx.cs" Inherits="PPC_VIEW_ViewCustomerSchedule" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Tentative Monthly Customer Schedule Report
                            </div>
                            <div class="tools">
                                                    ...
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlCustomer" CssClass="select2" Width="100%" runat="server"
                                                                MsgObrigatorio="Owner" TabIndex="1" AutoPostBack="true" OnSelectedIndexChanged="ddlCustomer_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="chkCustomerAll" EventName="CheckedChanged" />
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                </div>
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                        <ContentTemplate>
                                                            <asp:CheckBox ID="chkCustomerAll" runat="server" Checked="false" CssClass="checker"
                                                                Text="&nbspAll" AutoPostBack="True" TabIndex="10" OnCheckedChanged="chkCustomerAll_CheckedChanged" />
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
