...
public partial class PPC_ReportForms_VIEW_DailyFinalInspDispPerfView : System.Web.UI.Page
{
    static string right = "";
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        try
        {
            if (CommonClasses.ValidRights(int.Parse(right.Substring(0, 5)), this, "For Menu"))
            {
                ...
                string Type = "Machine";
                Response.Redirect("~/PPC/ReportForms/ADD/DailyFinalInspDispPerf.aspx?Title=" + Title + "&Date=" + txtMonth.Text + "&StrCond=" + StrCond + "&Type=" + Type + "&WeekCond=" + ddlWeek.SelectedValue + "", false);
            }
            else
            {
        ...
        {
            CommonClasses.SendError("Daily Final Insp Dispatch Performance Report", "btnShow_Click", Ex.Message);
        }
    }
    #endregion
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        {
            CommonClasses.SendError("Daily Final Insp Dispatch Performance Report", "LoadCustomer", Ex.Message);
        }
    }
    #endregion
    ...
    public bool ShowMessage(string DiveName, string Message, string MessageType)
    {
        ...
        {
            CommonClasses.SendError("Daily Final Insp Dispatch Performance Report", "ShowMessage", Ex.Message);
            return false;
        }
    }
    #endregion
