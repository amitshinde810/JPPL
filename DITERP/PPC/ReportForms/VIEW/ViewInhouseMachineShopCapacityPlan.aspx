<%@ Page Title="Inhouse Machine Shop Capacity Planning" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewInhouseMachineShopCapacityPlan.aspx.cs" Inherits="PPC_VIEW_ViewInhouseMachineShopCapacityPlan" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Inhouse Machine Shop Capacity Planning
                            </div>
                            <div class="tools">
