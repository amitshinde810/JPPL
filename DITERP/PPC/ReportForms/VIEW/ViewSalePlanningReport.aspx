<%@ Page Title="Sales Planning Report" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewSalePlanningReport.aspx.cs" Inherits="RoportForms_VIEW_ViewSalePlanningReport" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Sale Planning Report
                            </div>
                            <div class="tools">
                                                        ...
                                                        <ContentTemplate>
                                                            <div class="input-group">
                                                                <asp:TextBox ID="txtFromDate" OnTextChanged="txtFromDate_TextChanged" runat="server"
                                                                    AutoPostBack="true" placeholder="MMM yyyy" CssClass="form-control" TabIndex="6"
                                                        ...
                                                        <ContentTemplate>
                                                            <div class="input-group">
                                                                <asp:TextBox ID="txtToDate" runat="server" AutoPostBack="true" OnTextChanged="txtToDate_TextChanged"
                                                                    placeholder="dd MMM yyyy" Visible="false" CssClass="form-control" TabIndex="7" ValidationGroup="Save"></asp:TextBox>
                                                              <%--  <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
