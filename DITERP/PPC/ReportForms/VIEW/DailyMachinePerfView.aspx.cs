...
public partial class PPC_ReportForms_VIEW_DailyMachinePerfView : System.Web.UI.Page
{
    static string right = "";
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        try
        {
            if (CommonClasses.ValidRights(int.Parse(right.Substring(0, 5)), this, "For Menu"))
            {
                ...
                string Type = "Machine";
                Response.Redirect("~/PPC/ReportForms/ADD/DailyMachinePerf.aspx?Title=" + Title + "&Date=" + txtMonth.Text + "&StrCond=" + StrCond + "&Type=" + Type + "&WeekCond=" + ddlWeek.SelectedValue + "", false);
            }
            else
            {
