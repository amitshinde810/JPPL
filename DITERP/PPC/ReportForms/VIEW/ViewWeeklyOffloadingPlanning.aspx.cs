...
public partial class PPC_VIEW_ViewWeeklyOffloadingPlanning : System.Web.UI.Page
{
    static string right = "";
    ...
    private void LoadCombos()
    {
        ...
        dtPartName = CommonClasses.Execute("select DISTINCT I.I_CODE,I.I_CODENO + ' - ' + I.I_NAME AS ICODE_INAME from VENDOR_WEEKLY_PLAN VWP INNER JOIN ITEM_MASTER AS I ON VWP.VWP_I_CODE = I.I_CODE WHERE VWP.ES_DELETE=0 AND I.ES_DELETE=0 AND VWP.VWP_DATE='" + Convert.ToDateTime(txtMonth.Text).ToString("dd/MMM/yyyy") + "' and VWP.VWP_COMP_ID='" + (string)Session["CompanyId"] + "'");
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        try
        {
            if (CommonClasses.ValidRights(int.Parse(right.Substring(0, 5)), this, "For Menu"))
            {
                ...
                if (chkAllItem.Checked == true && chkAllWeek.Checked != true)
                    StrCond = StrCond + " VWP_WEEK='" + ddlWeek.SelectedValue + "' AND  ";
                if (chkAllItem.Checked != true && chkAllWeek.Checked == true)
                ...
                Response.Redirect("~/PPC/ReportForms/ADD/WeeklyOffloadingPlanning.aspx?Title=" + Title + "&Date=" + txtMonth.Text + "&StrCond=" + StrCond + "", false);
            }
            else
            {
        ...
        {
            CommonClasses.SendError("Weekly Sale Planning Report", "btnShow_Click", Ex.Message);
        }
    }
    #endregion
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        {
            CommonClasses.SendError("Weekly Sale Planning Report", "LoadCustomer", Ex.Message);
        }
    }
    #endregion
    ...
    public bool ShowMessage(string DiveName, string Message, string MessageType)
    {
        ...
        {
            CommonClasses.SendError("Weekly Sale Planning Report", "ShowMessage", Ex.Message);
            return false;
        }
    }
    #endregion
