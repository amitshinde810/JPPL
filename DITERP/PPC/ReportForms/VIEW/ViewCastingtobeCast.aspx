<%@ Page Title="Casting To Be Cast" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewCastingtobeCast.aspx.cs" Inherits="PPC_VIEW_ViewCastingtobeCast" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Casting To Be Cast
                            </div>
                            <div class="tools">
