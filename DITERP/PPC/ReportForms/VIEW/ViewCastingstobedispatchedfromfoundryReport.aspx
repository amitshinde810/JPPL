<%@ Page Title="Castings to be dispatched from foundry Report" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewCastingstobedispatchedfromfoundryReport.aspx.cs" Inherits="PPC_ReportForms_VIEW_ViewCastingstobedispatchedfromfoundryReport" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Castings to be dispatched from foundry Report
                            </div>
                            <div class="tools">
