<%@ Page Title="Purchase Requirement Report" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewPurchaseRequirement.aspx.cs" Inherits="PPC_VIEW_ViewPurchaseRequirement" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Purchase Requirement Report
                            </div>
                            <div class="tools">
                                                ...
                                                <div class="col-md-6">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel11">
                                                        ...
                                                        <Triggers>
                                                            ...
                                                            <%--<asp:AsyncPostBackTrigger ControlID="ddlBoughtOut" EventName="SelectedIndexChanged" />--%>
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlBoughtOut" OnSelectedIndexChanged="ddlBoughtOut_SelectedIndexChanged"
                                                                runat="server" AutoPostBack="True" CssClass="select2" Width="100%" TabIndex="9">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="chkBoughtOut" EventName="CheckedChanged" />
                                                            <asp:AsyncPostBackTrigger ControlID="ddlPartName" EventName="SelectedIndexChanged" />
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                </div>
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel4">
                                                        <ContentTemplate>
                                                            <asp:CheckBox ID="chkBoughtOut" runat="server" CssClass="checker" Text="&nbspAll"
                                                                AutoPostBack="True" TabIndex="10" OnCheckedChanged="chkBoughtOut_CheckedChanged" />
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
