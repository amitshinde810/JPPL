<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewSaleSummaryOwnerwise.aspx.cs"
    Inherits="RoportForms_VIEW_ViewSaleSummaryOwnerwise" Title="Sale Plan Summary Ownerwise Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    ...
    <script type="text/javascript">
        ...
        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function(evt, args) {
            jQuery("#<%=ddlGroupName.ClientID %>").select2();
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Sale Plan Summary Ownerwise
                            </div>
                            <div class="tools">
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="chkDateAll" runat="server" CssClass="checker" Text="&nbspAll" AutoPostBack="True"
                                                            TabIndex="8" OnCheckedChanged="chkDateAll_CheckedChanged" Visible="false" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlOwner" runat="server" Width="100%" AutoPostBack="True" CssClass="select2"
                                                            TabIndex="11" OnSelectedIndexChanged="ddlOwnerName_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="chkAllOwner" EventName="CheckedChanged" />
                                                    </Triggers>
                                                </asp:UpdatePanel>
                                            </div>
                                            <div class="col-md-2">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="chkAllOwner" runat="server" CssClass="checker" Text="&nbspAll"
                                                            AutoPostBack="True" TabIndex="12" OnCheckedChanged="chkAllOwner_CheckedChanged" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel4">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlGroupName" OnSelectedIndexChanged="ddlGroupName_SelectedIndexChanged"
