<%@ Page Title="Cores to be dispatched from core shop Report" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewCorestobedispatchedfromcoreshopReport.aspx.cs" Inherits="PPC_ReportForms_VIEW_ViewCorestobedispatchedfromcoreshopReport" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Cores to be dispatched from core shop Report
                            </div>
                            <div class="tools">
