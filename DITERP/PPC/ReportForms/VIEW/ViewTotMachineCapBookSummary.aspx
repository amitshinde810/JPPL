<%@ Page Title="Total Machining Capacity Booking Summary" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewTotMachineCapBookSummary.aspx.cs" Inherits="PPC_VIEW_ViewTotMachineCapBookSummary" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Total Machining Capacity Booking Summary
                            </div>
                            <div class="tools">
