<%@ Page Title="Castings Required To RFM From Foundry (For Vendor)" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewCastingsrequriedfromrfmforvendorReport.aspx.cs"
    Inherits="PPC_ReportForms_VIEW_ViewCastingsrequriedfromrfmforvendorReport" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Castings Required To RFM From Foundry (For Vendor)
                            </div>
                            <div class="tools">
