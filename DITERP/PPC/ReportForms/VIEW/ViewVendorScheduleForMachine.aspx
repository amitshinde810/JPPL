<%@ Page Title="Tentative Monthly Vendor Schedule " Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewVendorScheduleForMachine.aspx.cs" Inherits="PPC_VIEW_ViewVendorScheduleForMachine" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Tentative Monthly Vendor Schedule
                            </div>
                            <div class="tools">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlVendor" Width="100%" runat="server" Enabled="false" TabIndex="1"
                                                                AutoPostBack="true" OnSelectedIndexChanged="ddlVendor_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="chkVendorAll" EventName="CheckedChanged" />
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                </div>
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                        <ContentTemplate>
                                                            <asp:CheckBox ID="chkVendorAll" runat="server" Checked="true" CssClass="checker"
                                                                Text="&nbspAll" AutoPostBack="True" TabIndex="10" OnCheckedChanged="chkVendorAll_CheckedChanged" />
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
