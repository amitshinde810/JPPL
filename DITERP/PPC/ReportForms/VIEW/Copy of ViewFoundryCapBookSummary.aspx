<%@ Page Title="Foundry Capacity Booking Summary" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="Copy of ViewFoundryCapBookSummary.aspx.cs" Inherits="PPC_VIEW_ViewFoundryCapBookSummary" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Foundry Capacity Booking Summary
                            </div>
                            <div class="tools">
