...
public partial class RoportForms_ADD_CastingtobeInspectReport : System.Web.UI.Page
{
    ...
    private void GenerateReport(string Title, string Date, string StrCond)
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                rptname.Load(Server.MapPath("~/PPC/Reports/CastingToBeInspected.rpt"));
                rptname.FileName = Server.MapPath("~/PPC/Reports/CastingToBeInspected.rpt");
                rptname.Refresh();
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        try
        {
            Response.Redirect("~/PPC/ReportForms/VIEW/ViewCastingtobeInspectReport.aspx", false);
        }
        catch (Exception Ex)
        {
