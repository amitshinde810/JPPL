<%@ Page Title="Machine Master" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="MachineMaster.aspx.cs" Inherits="Masters_MachineMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtName" placeholder="Name" TabIndex="2"
                                                    runat="server" TextMode="SingleLine" MaxLength="100" MsgObrigatorio="Name"></asp:TextBox>
                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender13" TargetControlID="txtName"
    ...
    <script type="text/javascript">
        function VerificaCamposObrigatorios() {
            try {
                if (VerificaObrigatorio('#<%=txtName.ClientID%>', '#Avisos') == false) {
                    $("#Avisos").fadeOut(6000);
                    return false;
                }
                else {
