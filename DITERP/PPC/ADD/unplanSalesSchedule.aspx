<%@ Page Title="Unplan Sales Schedule" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="unplanSalesSchedule.aspx.cs" Inherits="PPC_ADD_unplanSalesSchedule" %>
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel8">
                                                    <ContentTemplate>
                                                        <asp:TextBox CssClass="form-control " ID="txtScheduleQty" placeholder="Schedule Qty"
                                                            AutoPostBack="true"  TabIndex="2" Text="0" runat="server" MaxLength="14"
