<%@ Page Title="Machine Quantity Master" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ProcessMachineMaster.aspx.cs" Inherits="Masters_ProcessMachineMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
                            ...
                            <div class="form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                                ...
                                                <asp:UpdatePanel runat="server" ID="upDIthem">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlProcess" CssClass="select2" Width="100%" runat="server"
                                                            MsgObrigatorio="Owner" TabIndex="1" AutoPostBack="true" OnSelectedIndexChanged="ddlProcess_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-4 control-label text-right">
                                                <span class="required">*</span> Number Of Machines Available
                                            </label>
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtNumbersOfMachines" placeholder="Numbers Of Machines"
                                                    ...
                                                    Text="0" TextMode="SingleLine" MaxLength="10" MsgObrigatorio="Numbers Of Machines"></asp:TextBox>
    ...
    <script type="text/javascript">
        function VerificaCamposObrigatorios() {
            try {
                if (VerificaObrigatorio('#<%=ddlProcess.ClientID%>', '#Avisos') == false) {
                    $("#Avisos").fadeOut(6000);
                    return false;
                }
