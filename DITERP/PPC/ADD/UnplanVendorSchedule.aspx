<%@ Page Title="Unplan Vendor Schedule" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="UnplanVendorSchedule.aspx.cs" Inherits="PPC_ADD_UnplanVendorSchedule" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Unplan Vendor Schedule
                            </div>
                            <div class="tools">
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    ...
                                                    <cc1:CalendarExtender ID="txtMonth_CalendarExtender" runat="server" Enabled="True"
                                                        Format="dd MMM yyyy" BehaviorID="calendar1" TargetControlID="txtMonth" PopupButtonID="txtMonth">
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox CssClass="form-control " ID="txtWeek1" placeholder="Tentative Week 1"
                                                            AutoPostBack="true" Enabled="true" TabIndex="2" Text="0" ValidChars="0123456789."
                                                            runat="server" MaxLength="14" MsgObrigatorio="Tentative Week 1" onkeypress="return validateFloatKeyPress(this,event);"
                                                            OnTextChanged="txtWeek4_TextChanged"></asp:TextBox>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox CssClass="form-control " ID="txtWeek2" placeholder="Tentative Week 2"
                                                            AutoPostBack="true" Enabled="true" ValidChars="0123456789." TabIndex="2" Text="0"
                                                            runat="server" MaxLength="14" MsgObrigatorio="Tentative Week 2" onkeypress="return validateFloatKeyPress(this,event);"
                                                            OnTextChanged="txtWeek4_TextChanged"></asp:TextBox>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox CssClass="form-control " ID="txtWeek3" placeholder="Tentative Week 3"
                                                            AutoPostBack="true" Enabled="true" ValidChars="0123456789." TabIndex="2" Text="0"
                                                            runat="server" MaxLength="14" MsgObrigatorio="Tentative Week 3" onkeypress="return validateFloatKeyPress(this,event);"
                                                            OnTextChanged="txtWeek4_TextChanged"></asp:TextBox>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox CssClass="form-control " ID="txtWeek4" placeholder="Tentative Week 4"
                                                            AutoPostBack="true" Enabled="true" ValidChars="0123456789." TabIndex="2" Text="0"
                                                            runat="server" MaxLength="14" MsgObrigatorio="Tentative Week 4" onkeypress="return validateFloatKeyPress(this,event);"
                                                            OnTextChanged="txtWeek4_TextChanged"></asp:TextBox>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
