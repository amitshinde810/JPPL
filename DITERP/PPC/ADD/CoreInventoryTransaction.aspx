<%@ Page Title="Core Inventory" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="CoreInventoryTransaction.aspx.cs" Inherits="Transactions_CoreInventoryTransaction" %>
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtActualQty" placeholder="Actual Qty" TabIndex="2"
                                                    runat="server" onkeypress="return validateFloatKeyPress(this,event);" Text="0"
                                                    TextMode="SingleLine" MaxLength="10" MsgObrigatorio="Box Qty" OnTextChanged="txtActualQty_TextChanged"></asp:TextBox>
                                            </div>
                                        </div>
                                        <%--   <div class="row">
                                        <div class="form-group">
