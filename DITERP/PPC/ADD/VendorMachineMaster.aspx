<%@ Page Title="Vendor Machine Quantity Master" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="VendorMachineMaster.aspx.cs" Inherits="Masters_VendorMachineMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlMachine" CssClass="select2" Width="100%" runat="server"
                                                            MsgObrigatorio="Owner" TabIndex="1" AutoPostBack="true" OnSelectedIndexChanged="ddlMachine_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtNumbersOfMachines" placeholder="Numbers Of Machines"
                                                    TabIndex="2" runat="server" Text="0" onkeypress="return validateFloatKeyPress(this,event);"
                                                    TextMode="SingleLine" MaxLength="10" MsgObrigatorio="Numbers Of Machines"></asp:TextBox>
                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender13" TargetControlID="txtNumbersOfMachines"
    ...
    <script type="text/javascript">
        function VerificaCamposObrigatorios() {
            try {
                if (VerificaObrigatorio('#<%=ddlVendor.ClientID%>', '#Avisos') == false) {
                    $("#Avisos").fadeOut(6000);
                    return false;
                }
                if (VerificaObrigatorio('#<%=ddlMachine.ClientID%>', '#Avisos') == false) {
                    $("#Avisos").fadeOut(6000);
                    return false;
                }
                if (VerificaObrigatorio('#<%=txtNumbersOfMachines.ClientID%>', '#Avisos') == false) {
                    $("#Avisos").fadeOut(6000);
                    return false;
                }
                else {
