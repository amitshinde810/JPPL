<%@ Page Title="Standard Inventory Master" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="StandardInventoryMaster.aspx.cs" Inherits="Masters_StandardInventoryMaster" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Standard Inventory Master
                            </div>
                            <div class="tools">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtFoundry" placeholder="Foundry" Enabled="true"
                                                    TabIndex="2" Text="0" runat="server" MaxLength="14" MsgObrigatorio="Foundry"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtRfmStore" placeholder="RfmStore" Enabled="true"
                                                    TabIndex="2" Text="0" runat="server" MaxLength="14" MsgObrigatorio="RfmStore"
                                                    onkeypress="return validateFloatKeyPress(this,event);"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtVendor" placeholder="Vendor" Enabled="true"
                                                    TabIndex="2" Text="0" runat="server" MaxLength="14" MsgObrigatorio="Vendor" onkeypress="return validateFloatKeyPress(this,event);"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label text-right">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtMainStore" placeholder="Main Store"
                                                    Enabled="true" TabIndex="2" Text="0" runat="server" MaxLength="14" MsgObrigatorio="Main Store"
                                                    onkeypress="return validateFloatKeyPress(this,event);"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtMachineShop" placeholder="Machine Shop"
                                                    Enabled="true" TabIndex="2" Text="0" runat="server" MaxLength="14" MsgObrigatorio="Machine Shop"
                                                    onkeypress="return validateFloatKeyPress(this,event);"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtRFIStore" placeholder="RFIStore" Enabled="true"
                                                    TabIndex="2" Text="0" runat="server" MaxLength="14" MsgObrigatorio="RFIStore"
                                                    onkeypress="return validateFloatKeyPress(this,event);"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtFinishGoods" placeholder="Finish Goods"
                                                    Enabled="true" TabIndex="2" Text="0" runat="server" MaxLength="14" MsgObrigatorio="Finish Goods"
                                                    onkeypress="return validateFloatKeyPress(this,event);"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtCustomer_Std_Stock" placeholder="Finish Goods"
                                                    Enabled="true" TabIndex="2" Text="0" runat="server" MaxLength="14" MsgObrigatorio="Customer Std Stock"
                                                    onkeypress="return validateFloatKeyPress(this,event);"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
