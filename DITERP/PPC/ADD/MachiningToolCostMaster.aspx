<%@ Page Title="Machining Tool Cost Master" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="MachiningToolCostMaster.aspx.cs" Inherits="Masters_MachiningToolCostMaster" %>
                            ...
                            <div class="form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-4 control-label text-right">
                                                <span class="required">*</span>Tool Cost/Comp
                                            </label>
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtToolCost" placeholder="Box Qty" TabIndex="2"
    ...
    <script type="text/javascript">
        function VerificaCamposObrigatorios() {
            try {
                ...
                if (VerificaObrigatorio('#<%=txtToolCost.ClientID%>', '#Avisos') == false) {
                    $("#Avisos").fadeOut(6000);
                    return false;
                }
                else {
