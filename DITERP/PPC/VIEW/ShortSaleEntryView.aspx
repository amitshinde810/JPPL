<%@ Page Title="Short Sale Entry" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ShortSaleEntryView.aspx.cs" Inherits="Transaction_ShortSaleEntryView" %>
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <asp:UpdatePanel runat="server" ID="upnlGridView">
                                <ContentTemplate>
                                    <asp:GridView ID="dgShortSaleEntry" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        GridLines="Both" DataKeyNames="SSEM_CODE" CssClass="table table-striped table-bordered table-advance table-hover"
                                        ...
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                        Text="" CommandArgument='<%# Bind("SSEM_CODE") %>'> <i class="fa fa-search"></i>View</asp:LinkButton>
                                                                </li>
                                                                <li>
                                                                    <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                        Text="" CommandArgument='<%# Bind("SSEM_CODE") %>'> <i class="fa fa-edit"></i>Modify</asp:LinkButton>
                                                                </li>
                                                                <li>
                                            ...
                                            <asp:TemplateField HeaderText="Short Sale Code" SortExpression="SSEM_CODE" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSSEM_CODE" CssClass="formlabel" runat="server" Text='<%# Bind("SSEM_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Date" SortExpression="SSEM_MONTH" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSSEM_MONTH" CssClass="formlabelUpper" runat="server" Text='<%# Eval("SSEM_MONTH") %>'></asp:Label>
                                                </ItemTemplate>
