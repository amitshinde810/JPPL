<%@ Page Title="Daily Sales Plan Entry" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="DailySaleEntryView.aspx.cs" Inherits="Transaction_DailySaleEntryView" %>
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <asp:UpdatePanel runat="server" ID="upnlGridView">
                                <ContentTemplate>
                                    <asp:GridView ID="dgDailySaleEntry" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        GridLines="Both" DataKeyNames="DSEM_CODE" CssClass="table table-striped table-bordered table-advance table-hover"
                                        ...
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                        Text="" CommandArgument='<%# Bind("DSEM_CODE") %>'> <i class="fa fa-search"></i>View</asp:LinkButton>
                                                                </li>
                                                                <li>
                                                                    <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                        Text="" CommandArgument='<%# Bind("DSEM_CODE") %>'> <i class="fa fa-edit"></i>Modify</asp:LinkButton>
                                                                </li>
                                                                <li>
                                            ...
                                            <asp:TemplateField HeaderText="Daily Sale Code" SortExpression="DSEM_CODE" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDSEM_CODE" CssClass="formlabel" runat="server" Text='<%# Bind("DSEM_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Date" SortExpression="DSEM_MONTH" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDSEM_MONTH" CssClass="formlabelUpper" runat="server" Text='<%# Eval("DSEM_MONTH") %>'></asp:Label>
                                                </ItemTemplate>
