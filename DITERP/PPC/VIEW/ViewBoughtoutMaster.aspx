<%@ Page Title="BOM For Boughtout Master" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewBoughtoutMaster.aspx.cs" Inherits="Masters_VIEW_ViewBoughtoutMaster" %>
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <asp:UpdatePanel runat="server" ID="upnlGridView">
                                <ContentTemplate>
                                    <asp:GridView ID="dgBoughtout" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        GridLines="Both" DataKeyNames="BOM_CODE" CssClass="table table-striped table-bordered table-advance table-hover"
                                        ...
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                        Text="" CommandArgument='<%# Bind("BOM_CODE") %>'> <i class="fa fa-search"></i>View</asp:LinkButton>
                                                                </li>
                                                                <li>
                                                                    <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                        Text="" CommandArgument='<%# Bind("BOM_CODE") %>'> <i class="fa fa-edit"></i>Modify</asp:LinkButton>
                                                                </li>
                                                                <li>
                                            ...
                                            <asp:TemplateField HeaderText="Group Code" SortExpression="BOM_CODE" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblBOM_CODE" CssClass="formlabel" runat="server" Text='<%# Bind("BOM_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
