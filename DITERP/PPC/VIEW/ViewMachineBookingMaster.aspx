<%@ Page Title="Machine Booking Master" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewMachineBookingMaster.aspx.cs" Inherits="Masters_VIEW_ViewMachineBookingMaster" %>
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <asp:UpdatePanel runat="server" ID="upnlGridView">
                                <ContentTemplate>
                                    <asp:GridView ID="dgMachineBooking" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        GridLines="Both" DataKeyNames="MBM_CODE" CssClass="table table-striped table-bordered table-advance table-hover"
                                        ...
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                        Text="" CommandArgument='<%# Bind("MBM_CODE") %>'> <i class="fa fa-search"></i>View</asp:LinkButton>
                                                                </li>
                                                                <li>
                                                                    <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                        Text="" CommandArgument='<%# Bind("MBM_CODE") %>'> <i class="fa fa-edit"></i>Modify</asp:LinkButton>
                                                                </li>
                                                                <li>
                                            ...
                                            <asp:TemplateField HeaderText="Part Name" SortExpression="ICODE_INAME" HeaderStyle-HorizontalAlign="Left" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblMBM_CODE" CssClass="formlabelUpper" runat="server" Text='<%# Eval("MBM_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <%--<asp:TemplateField HeaderText="Machine Name" SortExpression="M_NAME" HeaderStyle-HorizontalAlign="Left">
                                             ...
                                             <asp:TemplateField HeaderText="Number Of Units" SortExpression="MBM_NO_OF_UNITS" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblMBM_NO_OF_UNITS" CssClass="formlabelUpper" runat="server" Text='<%# Eval("MBD_NO_OF_UNITS") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                            </asp:TemplateField>--%>
                                        </Columns>
