<%@ Page Title="Core Inventory" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewCoreInventoryTransaction.aspx.cs" Inherits="Transaction_ViewCoreInventoryTransaction" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Core Inventory
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            ...
                            <asp:UpdatePanel runat="server" ID="upnlGridView">
                                <ContentTemplate>
                                    <asp:GridView ID="dgCore" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        GridLines="Both" DataKeyNames="CORE_CODE" CssClass="table table-striped table-bordered table-advance table-hover"
                                        ...
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                        Text="" CommandArgument='<%# Bind("CORE_CODE") %>'> <i class="fa fa-search"></i>View</asp:LinkButton>
                                                                </li>
                                                                <li>
                                                                    <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                        Text="" CommandArgument='<%# Bind("CORE_CODE") %>'> <i class="fa fa-edit"></i>Modify</asp:LinkButton>
                                                                </li>
                                                                <li>
                                            ...
                                            <asp:TemplateField HeaderText="Group Code" SortExpression="CORE_CODE" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCORE_CODE" CssClass="formlabel" runat="server" Text='<%# Bind("CORE_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="Month" SortExpression="CORE_MONTH" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCORE_MONTH" CssClass="formlabelUpper" runat="server" Text='<%# Eval("CORE_MONTH") %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Actual Qty" SortExpression="CORE_ACTUAL_QTY" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCORE_ACTUAL_QTY" CssClass="formlabelUpper" runat="server" Text='<%# Eval("CORE_ACTUAL_QTY") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                            </asp:TemplateField>
                                        </Columns>
