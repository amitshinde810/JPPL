<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Improvement.aspx.cs"
    Inherits="ToolRoom_ADD_Improvement" Title="Improvement Entry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    ...
    <%-- <script type="text/javascript">
        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function(evt, args) {
            jQuery("#<%=txtBreakDownDate.ClientID %>").form_datetime1()
        });
    </script>--%>
                ...
                <div class="col-md-8">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Improvement Entry
                            </div>
                            <div class="tools">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-3 control-label">
                                                    <span class="required">*</span> IMPROVEMENT NO.
                                                </label>
                                                <div class="col-md-4">
                                                    <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox placeholder="IMPROVEMENT NO. " MsgObrigatorio="IMPROVEMENT NO. " CssClass="form-control"
                                    ...
                                    <div class="row" runat="server" visible="false">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-3 control-label" runat="server" visible="false">
                                                    <span class="required">*</span> IMPROVEMENT SLIP NO.
                                                </label>
                                                <div class="col-md-4">
                                                    <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox placeholder="IMPROVEMENT SLIP NO. " Visible="false" MsgObrigatorio="IMPROVEMENT SLIP NO. "
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlPart" runat="server" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="ddlPart_SelectedIndexChanged"
                                                                CssClass="select2">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-3 control-label">
                                                    <span class="required">*</span> TOOLING HANDOVER DATE TIME
                                                </label>
                                                <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-3 control-label">
                                                    <span class="required">*</span> NATURE OF IMPROVEMENT
                                                </label>
                                                <div class="col-md-4">
                                                    <asp:TextBox placeholder=" NATURE OF IMPROVEMENT" CssClass="form-control" ID="txtReason"
                                                        runat="server" TextMode="MultiLine" TabIndex="4" Height="50px"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" id="close" runat="server">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-3 control-label">
                                                    <span class="required">*</span> TOOLING HADOVER TIME DATE
                                                </label>
                                                <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox placeholder=" TIME TAKEN FOR IMPROVEMENT  " CssClass="form-control"
                                                                ID="txtHours" runat="server" TabIndex="5" AutoPostBack="true" AutoCompleteType="Disabled"></asp:TextBox>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
