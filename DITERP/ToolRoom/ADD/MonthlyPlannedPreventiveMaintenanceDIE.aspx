<%@ Page Title="Monthly Planned Preventive maintenance" Language="C#" MasterPageFile="~/main.master"
    ...
    Inherits="ToolRoom_ADD_MonthlyPlannedPreventiveMaintenance" %>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel ID="UpdatePanel3ry" runat="server">
                                                        <ContentTemplate>
                                                            <div class="input-group">
                                                                <asp:TextBox CssClass="form-control input-sm" ID="txtMonth" MsgObrigatorio="Month"
                                                                    placeholder="Month" AutoPostBack="true" runat="server" TabIndex="3" runat="server"
                                                ...
                                                <div class="col-md-3">
                                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlWeek" CssClass="select2" AutoPostBack="true" Width="100%"
                                                                runat="server" MsgObrigatorio="select Week" TabIndex="4">
                                                                <asp:ListItem Text="1 Week" Value="0"></asp:ListItem>
                                                                <asp:ListItem Text="2 Week" Value="1"></asp:ListItem>
                                                                <asp:ListItem Text="3 Week" Value="2"></asp:ListItem>
                                                                <asp:ListItem Text="4 Week" Value="3"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlType" CssClass="select2" Width="100%" runat="server" MsgObrigatorio="Tool type"
                                                                TabIndex="5" AutoPostBack="true" OnSelectedIndexChanged="ddlType_SelectedIndexChanged">
