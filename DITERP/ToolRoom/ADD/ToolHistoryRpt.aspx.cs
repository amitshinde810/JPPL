...
public partial class ToolRoom_ADD_ToolHistoryRpt : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        try
        {
            ...
            GenerateReport(Title, Condition);
        }
        catch (Exception)
        {
        }
    ...
    private void GenerateReport(string Title, string Condition)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            rptname.Load(Server.MapPath("~/Reports/rptToolHistoryCardReport.rpt"));
            rptname.FileName = Server.MapPath("~/Reports/rptToolHistoryCardReport.rpt");

            rptname.Refresh();
            rptname.SetDataSource(dt);
            //rptname.SetParameterValue("txtCompName", Session["CompanyName"].ToString());
            //rptname.SetParameterValue("txtCompGST", Session["CompanyGST"].ToString());
            rptname.SetParameterValue("txtPeriod", "TOOL HISTORY CARD");
