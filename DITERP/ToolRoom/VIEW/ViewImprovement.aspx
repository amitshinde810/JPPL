<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewImprovement.aspx.cs"
    Inherits="ToolRoom_VIEW_ViewImprovement" Title="Improvement View" %>
                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="dgBreakdown" runat="server" AutoGenerateColumns="False" Width="100%"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Improvement No." SortExpression="B_NO" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Improvement Slip No." Visible="false" SortExpression="B_SLIPNO"
                                                            HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
