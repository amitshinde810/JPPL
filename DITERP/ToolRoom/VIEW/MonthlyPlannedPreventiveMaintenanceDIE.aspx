<%@ Page Title="Monthly Planned Preventive maintenance" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="MonthlyPlannedPreventiveMaintenanceDIE.aspx.cs"
    Inherits="ToolRoom_VIEW_MonthlyPlannedPreventiveMaintenanceDIE" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Monthly Planned Preventive Maintenance
                            </div>
                            <div class="tools">
                                ...
                                <div class="col-md-12">
                                    <div style="overflow: auto;">
                                        <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                            <ContentTemplate>
                                                <asp:GridView ID="dgMPPM" runat="server" Width="100%" AutoGenerateColumns="False"
                                                    CellPadding="4" Font-Size="12px" ShowFooter="false" Font-Names="Verdana" GridLines="Both"
                                                    CssClass="table table-striped table-bordered table-advance table-hover" DataKeyNames="PM_CODE"
                                                    OnRowDeleting="dgMPPM_RowDeleting" OnRowEditing="dgMPPM_RowEditing" OnPageIndexChanging="dgMPPM_PageIndexChanging"
                                                    OnRowCommand="dgMPPM_RowCommand" OnRowUpdating="dgMPPM_RowUpdating" AllowPaging="true"
                                                    PageSize="25">
                                                    <Columns>
                                                                        ...
                                                                        <ul class="dropdown-menu" role="menu">
                                                                            <li>
                                                                                <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                                    Text="View" CommandArgument='<%# Bind("PM_CODE") %>'><i class="fa fa-search"></i> View</asp:LinkButton>
                                                                            </li>
                                                                            <li>
                                                                                <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                                    Text="Modify" CommandArgument='<%# Bind("PM_CODE") %>'><i class="fa fa-edit"></i> Modify</asp:LinkButton>
                                                                            </li>
                                                                            <li>
                                                        ...
                                                        <asp:TemplateField HeaderText="PM_CODE" SortExpression="PM_CODE" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPM_CODE" runat="server" Text='<%# Bind("PM_CODE") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Month" SortExpression="PM_MONTH" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPM_MONTH" CssClass="" runat="server" Text='<%# Eval("PM_MONTH") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Week" SortExpression="PM_WEEK" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPM_WEEK" CssClass="" runat="server" Text='<%# Eval("PM_WEEK") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:TemplateField>
                                                    </Columns>
