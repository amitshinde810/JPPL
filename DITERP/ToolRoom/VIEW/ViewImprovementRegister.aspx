<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewImprovementRegister.aspx.cs"
    Inherits="ToolRoom_VIEW_ViewImprovementRegister" EnableEventValidation="false"
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Improvement Register
                            </div>
                            <div class="tools">
                                                    ...
                                                    <ContentTemplate>
                                                        <asp:GridView ID="dgBreakdown" runat="server" AutoGenerateColumns="False" Width="100%"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Improvement No" SortExpression="B_NO" Visible="false"
                                                                ...
                                                                <asp:TemplateField HeaderText="Improvement Slip No." SortExpression="B_SLIPNO" HeaderStyle-HorizontalAlign="Left">
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Improvement Date" SortExpression="B_DATE" HeaderStyle-HorizontalAlign="Left">
                                                                    <ItemTemplate>
