<%@ Page Title="3D Model Storage and Request For Revision" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="TDModelStorageNReqForRevision.aspx.cs" Inherits="ToolRoom_VIEW_TDModelStorageNReqForRevision" %>
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                            <ContentTemplate>
                                                <asp:GridView ID="dgMPPM" runat="server" Width="100%" AutoGenerateColumns="False"
                                                    ...
                                                    CssClass="table table-striped table-bordered table-advance table-hover" DataKeyNames="TMS_CODE"
                                                    ...
                                                    <Columns>
                                                                        ...
                                                                        <ul class="dropdown-menu" role="menu">
                                                                            <li>
                                                                                <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                                    Text="View" CommandArgument='<%# Bind("TMS_CODE") %>'><i class="fa fa-search"></i> View</asp:LinkButton>
                                                                            </li>
                                                                            <li>
                                                                                <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                                    Text="Modify" CommandArgument='<%# Bind("TMS_CODE") %>'><i class="fa fa-edit"></i> Modify</asp:LinkButton>
                                                                            </li>
                                                                            <li>
                                                        ...
                                                        <asp:TemplateField HeaderText="TMS_CODE" SortExpression="TMS_CODE" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblTMS_CODE" runat="server" Text='<%# Bind("TMS_CODE") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Revision date" SortExpression="TMS_REV_DATE" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblTMS_REV_DATE" CssClass="" runat="server" Text='<%# Eval("TMS_REV_DATE") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:TemplateField>
                                                    </Columns>
