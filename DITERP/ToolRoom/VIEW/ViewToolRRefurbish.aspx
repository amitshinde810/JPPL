<%@ Page Title="Tools For Refurbish" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewToolRRefurbish.aspx.cs" Inherits="ToolRoom_VIEW_ViewToolRRefubrish" %>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="dgWPM" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        CssClass="table table-striped table-bordered table-advance table-hover" DataKeyNames="TRR_CODE"
                                        ...
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                        Text="View" CommandArgument='<%# Bind("TRR_CODE") %>'><i class="fa fa-search"></i> View</asp:LinkButton>
                                                                </li>
                                                                <li>
                                                                    <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                        Text="Modify" CommandArgument='<%# Bind("TRR_CODE") %>'><i class="fa fa-edit"></i> Modify</asp:LinkButton>
                                                                </li>
                                                                <li>
                                            ...
                                            <asp:TemplateField HeaderText="WPM_CODE" SortExpression="WPM_CODE" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTRR_CODE" runat="server" Text='<%# Bind("TRR_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Type" SortExpression="TRR_TYPE" HeaderStyle-HorizontalAlign="Left"
                                                Visible="true">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTRR_TYPE" CssClass="" runat="server" Text='<%# Eval("TRR_TYPE") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Refurbish Rev. No." SortExpression="TRR_REF_REV_NO"
                                                HeaderStyle-HorizontalAlign="Left" Visible="true">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTRR_REF_REV_NO" CssClass="" runat="server" Text='<%# Eval("TRR_REF_REV_NO") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" Width="200px"/>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="STD. PROD." SortExpression="TRR_STD_PROD" HeaderStyle-CssClass="text-right"
                                                Visible="true">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTRR_STD_PROD" CssClass="text-right" runat="server" Text='<%# Eval("TRR_STD_PROD") %>'></asp:Label>
                                                </ItemTemplate>
