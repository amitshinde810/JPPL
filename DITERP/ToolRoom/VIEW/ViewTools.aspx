<%@ Page Language="C#" Title="Tooling Master" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewTools.aspx.cs" Inherits="ToolRoom_VIEW_ViewTools" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    ...
    <script type="text/javascript">
        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function(evt, args) {
            jQuery("#<%=ddlTType.ClientID %>").select2();
        });
    </script>
        ...
        <div class="page-content">
            <div class="row">
                <div id="MSG" class="col-md-12">
                    ...
                    <asp:Label ID="lblCount" runat="server" Style="color: #9f6000; font-size: medium;
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-2">
                                                <asp:UpdatePanel runat="server" ID="upType">
                                                    <ContentTemplate>
                                                        <asp:DropDownList runat="server" ID="ddlTType" CssClass="select2" AutoPostBack="true"
                                                            OnSelectedIndexChanged="ddlTType_SelectedIndexChanged" Width="100%">
                                                            <asp:ListItem Text="All" Value="-1"></asp:ListItem>
                                                            <asp:ListItem Text="DIE" Value="0"></asp:ListItem>
                                                            <%--<asp:ListItem Text="CORE BOX" Value="1"></asp:ListItem>--%>
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="dgToolMaster" runat="server" Width="100%" AutoGenerateColumns="False"
                                                CellPadding="4" Font-Size="12px" ShowFooter="false" ShowHeader="true" Font-Names="Verdana"
                                                GridLines="Both" CssClass="table table-striped table-bordered table-advance table-hover"
                                                DataKeyNames="T_CODE" OnRowDeleting="dgToolMaster_RowDeleting" OnRowEditing="dgToolMaster_RowEditing"
                                                OnPageIndexChanging="dgToolMaster_PageIndexChanging" OnRowDataBound="dgToolMaster_RowDataBound"
                                                OnRowCommand="dgToolMaster_RowCommand" OnRowUpdating="dgToolMaster_RowUpdating"
                                                ...
                                                <Columns>
                                                                    ...
                                                                    <ul class="dropdown-menu" role="menu">
                                                                        <li>
                                                                            <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                                Text="View" CommandArgument='<%# Bind("T_CODE") %>'><i class="fa fa-search"></i> View</asp:LinkButton>
                                                                        </li>
                                                                        <li>
                                                    ...
                                                    <asp:TemplateField HeaderText="T_CODE" SortExpression="T_CODE" Visible="false">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Tool Type" SortExpression="T_TYPE" HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblT_TYPE" CssClass="" runat="server" Text='<%# Eval("T_TYPE") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Tool Image" Visible="false" SortExpression="T_PHOTO_PATH"
                                                        HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblToolCount" CssClass="" runat="server" Text='<%# Eval("ToolCount") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="3D Image" Visible="false" SortExpression="T_3D_PATH"
                                                        HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblTCount" CssClass="" runat="server" Text='<%# Eval("DCount") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:Label ID="txtToolImg" runat="server"></asp:Label>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkTToolmage" BorderStyle="None" runat="server" CausesValidation="False"
                                                                CommandName="ViewPDF" Text='<%# Eval("T_PHOTO_PATH") %>' CommandArgument='<%#Container.DataItemIndex%>'></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:Label ID="txtTImage" runat="server"></asp:Label>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkTPhotoImage" BorderStyle="None" runat="server" CausesValidation="False"
