<%@ Page Title="BREAKDOWN OCCURANCE CHART" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewBreakdownOccuChartReport.aspx.cs" Inherits="ToolRoom_VIEW_ViewBreakdownOccuChartReport" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>BREAKDOWN OCCURANCE CHART
                            </div>
                            <div class="tools">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-3 text-right" runat="server" visible="false">
                                                    Report Type:
                                                </label>
                                                <div class="col-md-6">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel29">
                                                        <ContentTemplate>
                                                            <asp:RadioButtonList RepeatDirection="Horizontal" visible="false" CssClass="checker" ID="tbType"
                                                                AutoPostBack="true" runat="server" OnSelectedIndexChanged="tbType_SelectedIndexChanged">
                                                                <asp:ListItem Value="0">&nbsp Monthly &nbsp&nbsp&nbsp</asp:ListItem>
                                                                <%--<asp:ListItem Value="1">&nbsp Yearly &nbsp&nbsp&nbsp</asp:ListItem>--%>
                                                            </asp:RadioButtonList>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel5">
                                                        ...
                                                        <Triggers>
                                                            ...
                                                            <%--<asp:AsyncPostBackTrigger ControlID="tbType" EventName="SelectedIndexChanged" />--%>
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                </div>
                                                <label class="col-md-2 control-label text-right" runat="server" visible="false">
                                                    To
                                                </label>
                                                <div class="col-md-3">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel4">
                                                        <ContentTemplate>
                                                            <div class="input-group">
                                                                <asp:TextBox ID="txtTodate" runat="server" visible="false" placeholder="MMM yyyy" CssClass="form-control"
                                                                    TabIndex="6" ValidationGroup="Save" AutoPostBack="true" OnTextChanged="txtTodate_TextChanged"></asp:TextBox>
                                                                <span class="input-group-addon" runat="server" visible="false"><i class="fa fa-calendar" runat="server" visible="false"></i></span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel8">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlTool" runat="server" OnSelectedIndexChanged="ddlTool_SelectedIndexChanged"
                                                                CssClass="select2" Width="100%" MsgObrigatorio="Item" TabIndex="9" AutoPostBack="true">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="txtFromDate" EventName="TextChanged" />
                                                ...
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel12">
                                                        <ContentTemplate>
                                                            <asp:CheckBox ID="chkAlltool" runat="server" CssClass="checker" Text="&nbspAll" AutoPostBack="True"
                                                                TabIndex="10" OnCheckedChanged="chkAlltool_CheckedChanged" />
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
