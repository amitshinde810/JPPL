<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewBreakdownRegister.aspx.cs"
    Inherits="ToolRoom_VIEW_ViewBreakdownRegister" Title="Breakdown Register" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Breakdown Register
                            </div>
                            <div class="tools">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel8">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlTool" runat="server" CssClass="select2" Width="100%" MsgObrigatorio="Item"
                                                    ...
                                                    <ContentTemplate>
                                                        <asp:GridView ID="dgBreakdown" runat="server" AutoGenerateColumns="False" Width="100%"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Breakdown Slip No." SortExpression="B_SLIPNO" HeaderStyle-HorizontalAlign="Left">
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Action" SortExpression="B_ACTION" HeaderStyle-HorizontalAlign="Left">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblB_ACTION" runat="server" Text='<%# Eval("B_ACTION") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Report" SortExpression="IM_CODE" HeaderStyle-HorizontalAlign="Left">
                                                                 ...
                                                                 <asp:TemplateField HeaderText="Download" Visible="true" SortExpression="IM_CODE" HeaderStyle-HorizontalAlign="Left">
                                                                    <ItemTemplate>
                                                                        <%--<asp:Label ID="lblB_FILE" runat="server" Text='<%# Eval("B_FILE") %>'></asp:Label>--%>
                                                                        <asp:LinkButton ID="lnkView1" BorderStyle="None" runat="server" CausesValidation="False"
                                                                            CommandName="Download" Text='<%# Eval("B_FILE") %>' CommandArgument='<%#Container.DataItemIndex%>'></asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Status" SortExpression="B_STATUS" HeaderStyle-HorizontalAlign="Left">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblB_STATUS" runat="server" Text='<%# Eval("B_STATUS") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
