<%@ Page Title="Weely Preventive Maintenance" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewWeeklyPM.aspx.cs" Inherits="ToolRoom_VIEW_ViewWeeklyPM" %>
                ...
                <div class="col-md-8">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Weely Preventive Maintenance
                            </div>
                            <div class="tools">
