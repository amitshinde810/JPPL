<%@ Page Title="Issue Fill Off Sheet" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="IssueFillOffSheet.aspx.cs" Inherits="Transactions_ADD_IssueFillOffSheet" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Issue Fill Off Sheet
                            </div>
                            <div class="tools">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label class="col-md-2 control-label label-sm">
                                                <font color="red">*</font> Sheet No.
                                            </label>
                                            <div class="col-md-3">
                                                <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlSheetNo" CssClass="select2_category form-control" runat="server"
                                                            MsgObrigatorio="Sheet No" TabIndex="1" AutoPostBack="true" OnSelectedIndexChanged="ddlSheetNo_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                            ...
                                            <div class="col-md-2 ">
                                                <asp:TextBox ID="txtDocNo" runat="server" placeholder="Doc No" CssClass="form-control"
                                                    ValidationGroup="Save" ReadOnly="true" TabIndex="2"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlbatchNo" CssClass="select2_category form-control" runat="server"
                                                            MsgObrigatorio="Batch No" TabIndex="3" OnSelectedIndexChanged="ddlBatchNo_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    <asp:TextBox ID="txtDate" runat="server" CssClass="form-control" placeholder="dd MMM yyyy"
                                                        ValidationGroup="Save" TabIndex="4" MsgObrigatorio="Date" ReadOnly="false"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtApprovedBy" placeholder="Approved By"
                                                    TabIndex="7" runat="server" MaxLength="100" MsgObrigatorio="Approved By" ReadOnly="true"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <asp:TextBox CssClass="form-control " ID="txtSpecInstruction" placeholder="Special Instruction"
                                                    TabIndex="8" runat="server" TextMode="SingleLine" Rows="1" MsgObrigatorio="Special Instruction"
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlType" CssClass="select2_category form-control input-sm"
                                                                runat="server" MsgObrigatorio="Type" TabIndex="9">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtBarrels" placeholder="0.000"
                                                                TabIndex="10" runat="server" MsgObrigatorio="Barrels"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtQty" placeholder="0.000"
                                                                TabIndex="11" runat="server" MsgObrigatorio="Quantity"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlUnit" CssClass="select2_category form-control input-sm"
                                                                runat="server" MsgObrigatorio="Type" TabIndex="12">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                    ...
                                    <div class="row" style="overflow: auto; width: 100%">
                                        <div class="col-md-12">
                                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                <ContentTemplate>
                                                    <asp:GridView ID="dgvFillDetail" runat="server" TabIndex="14" Style="width: 100%;"
                                                        AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-advance table-hover"
                                                        CellPadding="4" GridLines="Both" OnRowDeleting="dgvFillDetail_Deleting" OnRowCommand="dgvFillDetail_RowCommand">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Type" SortExpression="FOSD_TYPE" Visible="False">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Barrels" SortExpression="FOSD_QTY" HeaderStyle-HorizontalAlign="Right"
                                                            ...
                                                            <asp:TemplateField HeaderText="Issue Qty" SortExpression="StockQty" HeaderStyle-HorizontalAlign="Right"
                                                                Visible="true" HeaderStyle-Width="200px">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtIssueQty" runat="server" CssClass="form-control text-right" placeholder="0.00"
                                                                        MsgObrigatorio="Qty" Text='<%# Eval("FOSD_ISSUE_QTY") %>' AutoPostBack="true"
                                                                        OnTextChanged="txtIssueQty1_TextChanged" MaxLength="50" TabIndex="14"></asp:TextBox>
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtFillby" placeholder="Filled By" TabIndex="15"
                                                    runat="server" MaxLength="100" MsgObrigatorio="Filled By" ReadOnly="true"></asp:TextBox>
                                            </div>
                                            <label class="col-md-2 control-label text-right ">
                                                Fill Date
                                            </label>
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    <asp:TextBox ID="txtFillDate" runat="server" CssClass="form-control" placeholder="dd MMM yyyy"
                                                        ValidationGroup="Save" TabIndex="16" MsgObrigatorio="Fill Date" ReadOnly="true"></asp:TextBox>
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                    <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Enabled="True" Format="dd MMM yyyy"
                                                        TargetControlID="txtFillDate" PopupButtonID="txtFillDate">
                                                    </cc1:CalendarExtender>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <asp:TextBox CssClass="form-control text-right" ID="txtFinalyield" placeholder="0.00"
                                                    TabIndex="17" runat="server" MsgObrigatorio="Final Yield" ReadOnly="true"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <asp:TextBox CssClass="form-control " ID="txtNotes" placeholder="Notes" TabIndex="18"
                                                    runat="server" Rows="1" MsgObrigatorio="Notes" ReadOnly="true"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtFilterUsed" placeholder="Filter Used"
                                                    TabIndex="19" runat="server" MaxLength="50" MsgObrigatorio="Filter Used" ReadOnly="true"></asp:TextBox>
                                            </div>
                                            <label class="col-md-2 control-label label-sm">
                                                Filter Unit
                                            </label>
                                            <div class="col-md-3">
                                                <asp:DropDownList ID="ddlFilterUnit" CssClass="select2_category form-control" runat="server"
                                                    MsgObrigatorio="Filter Unit" TabIndex="20">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        function VerificaCamposObrigatorios() {
            try {
                ...
                if (VerificaValorCombo('#<%=ddlSheetNo.ClientID%>', '#Avisos') == false) {
                    $("#Avisos").fadeOut(6000);
                    return false;
                }
