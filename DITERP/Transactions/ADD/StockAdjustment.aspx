                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label label-sm">
                                                    <span class="required">*</span> To Store
                                                </label>
                                                <div class="col-md-3">
                                                ...
                                                <ContentTemplate>
                                                    <asp:GridView ID="dgStockAdjustment" runat="server" TabIndex="9" Style="width: 100%;"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="To Store" SortExpression="NoOfPackes" Visible="false"
                                                                HeaderStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSAD_TO_STORE" runat="server" Text='<%# Eval("SAD_TO_STORE") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="To Store" Visible="false" SortExpression="NoOfPackes"
                                                                HeaderStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSAD_TO_STORE_CODE" runat="server" Text='<%# Eval("SAD_TO_STORE_CODE") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" />
                                                            </asp:TemplateField>
                                                        </Columns>
