<%@ Page Title="Purchase Schedule Approval" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="PurchaseScheduleApproval.aspx.cs" Inherits="Transactions_ADD_PurchaseScheduleApproval" %>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                        <ContentTemplate>
                                                            <asp:GridView ID="dgMaterialAcceptance" runat="server" Width="100%" AutoGenerateColumns="False"
                                                                ...
                                                                OnPageIndexChanging="dgMaterialAcceptance_PageIndexChanging">
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Purchase QTY" SortExpression="PA_QTY_PPC" ItemStyle-HorizontalAlign="Right"
                                                                        HeaderStyle-HorizontalAlign="Right">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtPA_QTY_PPC" CssClass="text-right" OnTextChanged="txtPA_QTY_PPC_TextChanged"
                                                                                onkeypress="return validateFloatKeyPress(this,event);" runat="server" AutoPostBack="true"
                                                                                Text='<%# Eval("PA_QTY_PPC") %>'></asp:TextBox>
                                                                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" TargetControlID="txtPA_QTY_PPC"
                                                                                ValidChars="0123456789." runat="server" />
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Right" CssClass="text-right" />
                                                                        <ItemStyle HorizontalAlign="Right" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Inward QTY" SortExpression="IWD_QTY" ItemStyle-HorizontalAlign="Right"
                                                                        HeaderStyle-HorizontalAlign="Right">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblIWD_QTY" CssClass="" runat="server" Text='<%# Eval("IWD_QTY") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Right" CssClass="text-right" />
                                                                        <ItemStyle HorizontalAlign="Right" />
                                                                    </asp:TemplateField>
