<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="LabourChargeInvoice.aspx.cs"
    Inherits="Transactions_ADD_LabourChargeInvoice" Title="Labour Charge Invoice/Delivery Challan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    ...
    <script type="text/javascript">
        ...
        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function(evt, args) {
            ...
            jQuery("#<%=ddlInvoiceType.ClientID %>").select2();
        });
    </script>
                                                    ...
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel65">
                                                        <ContentTemplate>
                                                            <asp:RadioButtonList ID="rbtGroup" runat="server" AutoPostBack="True" TabIndex="1"
                                                                RepeatDirection="Horizontal" OnSelectedIndexChanged="rbtGroup_SelectedIndexChanged" CssClass="checker" CellPadding="10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel ID="UpdatePanel49" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlInvoiceType" Width="100%" AutoPostBack="true" CssClass="select2"
                                                                runat="server" TabIndex="2">
                                                                <asp:ListItem Value="0">As Per BOM</asp:ListItem>
                                                                <asp:ListItem Value="1" Selected="True">One To One</asp:ListItem>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                    ...
                                                    <asp:UpdatePanel ID="upddate" runat="server">
                                                        <ContentTemplate>
                                                            <div class="input-group">
                                                                <asp:TextBox CssClass="form-control" placeholder="dd MMM yyyy" ID="txtDate" TabIndex="3"
                                                ...
                                                <div class="col-md-2">
                                                    <asp:TextBox CssClass="form-control input-sm" ID="txtInvoiceNo" placeholder="Invoice No."
                                                        TabIndex="4" runat="server" Enabled="false"></asp:TextBox>
                                                </div>
                                                <label class="col-md-2 control-label" visible="false" runat="server">
                                                    Is Suppliementory
                                                </label>
                                                <div class="col-md-1" visible="false" runat="server">
                                                    <asp:UpdatePanel ID="UpdatePanel41" runat="server">
                                                        <ContentTemplate>
                                                            <label class="checkbox">
                                                                <asp:CheckBox ID="chkIsSuppliement" runat="server" CssClass="checker" TabIndex="5"
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlItemCode" CssClass="select2" Width="280px" runat="server"
                                                                TabIndex="6" AutoPostBack="True" MsgObrigatorio="Item Code" OnSelectedIndexChanged="ddlItemCode_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlItemName" CssClass="select2" Width="380px" runat="server"
                                                                TabIndex="7" AutoPostBack="True" MsgObrigatorio="Item Name" OnSelectedIndexChanged="ddlItemName_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlPONo" CssClass="select2" Width="100%" runat="server" TabIndex="8"
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtStockQty" placeholder="0.000"
                                                                runat="server" AutoPostBack="true" ReadOnly="true" TabIndex="10"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel18" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtPendingQty" placeholder="0.000"
                                                                ReadOnly="true" TabIndex="11" runat="server" AutoPostBack="true"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel24" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtVQty" placeholder="0.000"
                                                                TabIndex="12" runat="server" MaxLength="15" AutoPostBack="true" MsgObrigatorio="Invoice Qty"
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel20" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtActWght" placeholder="0.00"
                                                                runat="server" ReadOnly="true" AutoPostBack="true" TabIndex="13" MsgObrigatorio="Actual Wght"></asp:TextBox>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel67" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <asp:TextBox CssClass="form-control text-right input-sm" ID="txtRate" Text="0.00"
                                                            ...
                                                            OnTextChanged="txtRate_TextChanged" MaxLength="15" TabIndex="14"></asp:TextBox>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <asp:TextBox CssClass="form-control text-right input-sm" ID="txtAmount" placeholder="0.00"
                                                            TabIndex="15" runat="server" ReadOnly="true" MsgObrigatorio="Amount"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel44" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtAmortAmount" placeholder="0.000"
                                                                ReadOnly="true" TabIndex="17" runat="server" AutoPostBack="true"></asp:TextBox>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel29" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtBatchNo" placeholder="Batch No"
                                                                TabIndex="18" runat="server" MsgObrigatorio="Batch No" AutoPostBack="true" MaxLength="50"></asp:TextBox>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="btnInsert" EventName="Click" />
                                                            <asp:AsyncPostBackTrigger ControlID="dgInvoiceAddDetail" EventName="RowCommand" />
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel30" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" OnTextChanged="txtNoPackaeg_TextChanged"
                                                                ID="txtNoPackaeg" placeholder="0" TabIndex="19" runat="server" MsgObrigatorio="No Of Packages"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel31" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" Enabled="false" ID="txtQtyPerPack"
                                                                Text="0.00" placeholder="0.00" TabIndex="20" runat="server" MsgObrigatorio="Qty Per Pack"
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel42" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <asp:TextBox CssClass="form-control input-sm" ID="txtPackDesc" MsgObrigatorio="Pack Description"
                                                            placeholder="Pack Description" MaxLength="50" TabIndex="21" runat="server"></asp:TextBox>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="btnInsert" EventName="Click" />
                                                        <asp:AsyncPostBackTrigger ControlID="dgInvoiceAddDetail" EventName="RowCommand" />
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel53" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlTariff" CssClass="select2_category form-control" runat="server"
                                                                TabIndex="22" AutoPostBack="True" MsgObrigatorio="Unit" Enabled="false" Visible="True">
                                                            </asp:DropDownList>
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    <label class="control-label label-sm">
                                                        &nbsp</label><br />
                                                    <asp:LinkButton ID="btnInsert" CssClass="btn blue  btn-sm" TabIndex="23" runat="server"
                                        ...
                                        <div class="row" style="overflow: auto; width: 100%">
                                            <div class="col-md-12">
                                                <asp:UpdatePanel ID="UpdatePanel26" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <asp:GridView ID="dgInvoiceAddDetail" runat="server" TabIndex="24" Style="width: 100%;"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="PO No." SortExpression="PO_NO" Visible="True">
                                                                    <ItemTemplate>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel45" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtstroreloc" placeholder="Amort Amount"
                                                                TabIndex="25" runat="server" MaxLength="150" ReadOnly="true"></asp:TextBox>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="dgInvoiceAddDetail" EventName="RowCommand" />
                                                            <asp:AsyncPostBackTrigger ControlID="btnInsert" EventName="Click" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <asp:TextBox CssClass="form-control input-sm" ID="txtVechicleNo" placeholder="Vechical No."
                                                        TabIndex="27" runat="server" MaxLength="100"></asp:TextBox>
                                                </div>
                                                <label class="col-md-2 control-label label-sm">
                                                    Discount %
                                                </label>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtDiscPer" Text="0.00"
                                                                placeholder="0.00" TabIndex="28" MaxLength="5" runat="server" AutoPostBack="true"
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel21" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtDiscAmt" Text="0.00"
                                                                placeholder="0.00" TabIndex="29" Enabled="false" runat="server" AutoPostBack="true"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <asp:TextBox CssClass="form-control input-sm" ID="txtTransport" placeholder="Transport"
                                                        TabIndex="30" runat="server" MaxLength="255"></asp:TextBox>
                                                </div>
                                                <label class="col-md-2 control-label label-sm">
                                                    Packing Amount
                                                </label>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel15" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtPackAmt" Text="0.00"
                                                                placeholder="0.00" MaxLength="15" TabIndex="31" runat="server" AutoPostBack="true"
                                                                OnTextChanged="txtPackAmt_TextChanged"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel12" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtAccessableAmt" Text="0.00"
                                                                placeholder="0.00" TabIndex="32" Enabled="false" runat="server" AutoPostBack="true"></asp:TextBox>
                                                        ...
                                                        <ContentTemplate>
                                                            <div class="input-group">
                                                                <asp:TextBox CssClass="form-control" placeholder="dd MMM yyyy" ID="txtIssuedate"
                                                                    TabIndex="33" runat="server" MsgObrigatorio="Please Enter Issue Date" TextMode="SingleLine"
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel9" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox Visible="true" CssClass="form-control text-right input-sm" ID="txtBasicExcPer"
                                                                placeholder="0.00" MaxLength="5" TabIndex="34" runat="server" AutoPostBack="true"
                                                                Text="0.00" OnTextChanged="txtBasicExcPer_TextChanged"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        <asp:TextBox CssClass="form-control" ID="txtIssuetime" TabIndex="36" runat="server"
                                                            MsgObrigatorio="Please Enter Issue Time" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>
                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel10" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox Visible="true" CssClass="form-control text-right input-sm" ID="txtducexcper"
                                                                placeholder="0.00" TabIndex="37" MaxLength="5" runat="server" Text="0.00" OnTextChanged="txtducexcper_TextChanged"
                                                                AutoPostBack="true"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel23" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtEdueceAmt" Text="0.00"
                                                                placeholder="0.00" TabIndex="38" runat="server" Enabled="false" OnTextChanged="txtducexcper_TextChanged"
                                                                AutoPostBack="true"></asp:TextBox>
                                                        ...
                                                        <ContentTemplate>
                                                            <div class="input-group">
                                                                <asp:TextBox CssClass="form-control" placeholder="dd MMM yyyy" ID="txtremovaldate"
                                                                    TabIndex="39" runat="server" MsgObrigatorio="Please Enter Issue Date" TextMode="SingleLine"
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel11" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox Visible="true" CssClass="form-control text-right input-sm" ID="txtSHEExcPer"
                                                                placeholder="0.00" TabIndex="40" MaxLength="5" AutoPostBack="true" runat="server"
                                                                Text="0.00" OnTextChanged="txtSHEExcPer_TextChanged"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel27" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtSHEExcAmt" Text="0.00"
                                                                placeholder="0.00" TabIndex="41" runat="server" Enabled="false"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        <asp:TextBox CssClass="form-control" ID="txtRemoveltime" TabIndex="42" runat="server"
                                                            MsgObrigatorio="Please Enter Removel Time" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>
                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel33" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtTaxableAmt" Text="0.00"
                                                                placeholder="0.00" TabIndex="43" MaxLength="15" ReadOnly="true" runat="server"
                                                                AutoPostBack="true" OnTextChanged="txtTaxableAmt_TextChanged"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel14" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlTaxName" CssClass="select2" Width="300px" Enabled="false"
                                                                runat="server" TabIndex="44" AutoPostBack="True" OnSelectedIndexChanged="ddlTaxName_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="btnInsert" EventName="Click" />
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel13" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtSalesTaxPer" placeholder="0.00"
                                                                TabIndex="45" runat="server" MaxLength="5" Text="0.00" OnTextChanged="txtSalesTaxPer_TextChanged"
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel25" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtSalesTaxAmount" placeholder="0.00"
                                                                TabIndex="46" runat="server" Enabled="false"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <asp:TextBox CssClass="form-control" placeholder="L R No." ID="txtLRNo" TabIndex="47"
                                                        MaxLength="50" runat="server" MsgObrigatorio="L R No." TextMode="SingleLine"></asp:TextBox>
                                                </div>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel34" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtOtherCharges" Text="0.00"
                                                                placeholder="0.00" TabIndex="48" MaxLength="15" runat="server" AutoPostBack="true"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        <asp:TextBox CssClass="form-control" placeholder="dd MMM yyyy" ID="txtLRDate" TabIndex="49"
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel35" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtFreight" Text="0.00"
                                                                placeholder="0.00" MaxLength="15" TabIndex="50" runat="server" AutoPostBack="true"
                                                                OnTextChanged="txtFreight_TextChanged"></asp:TextBox>
                                    ...
                                    <div class="row" visible="false" runat="server">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <asp:TextBox CssClass="form-control" placeholder="Remark" ID="txtRemark" TabIndex="51"
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel36" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtIncurance" Text="0.00"
                                                                placeholder="0.00" TabIndex="52" runat="server" AutoPostBack="true" OnTextChanged="txtIncurance_TextChanged"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel40" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtRoundingAmt" Text="0.00"
                                                                placeholder="0.00" TabIndex="52" runat="server" MaxLength="15" AutoPostBack="true"
