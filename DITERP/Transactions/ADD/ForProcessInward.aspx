<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ForProcessInward.aspx.cs"
    Inherits="Transactions_ADD_ForProcessInward" Title="For Process Inward" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    ...
    <script type="text/javascript">
        ...
        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function(evt, args) {
            jQuery("#<%=ddlItemName.ClientID %>").select2(); //ddlInwardType
                                ...
                                <div class="form-body">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlInwardType" runat="server" AutoPostBack="true" TabIndex="1"
                                                                OnSelectedIndexChanged="ddlInwardType_SelectedIndexChanged" CssClass="select2" Width="100%">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlSupplier" runat="server" TabIndex="1" CssClass="select2" Width="100%"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label text-right">
                                                    <font color="red">*</font>Excise Doc</label>
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel ID="UpdatePanel19" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="txtInvoiceNo" runat="server" CssClass="form-control text-right input-sm"
                                                                placeholder="0" TabIndex="5" AutoPostBack="true" MaxLength="100" MsgObrigatorio=" Enter Excise No"></asp:TextBox>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                                <label class="col-md-2 control-label text-right">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="txtInvoiceNo1" runat="server" CssClass="form-control text-right input-sm"
    ...
    <script type="text/javascript">
        function VerificaCamposObrigatorios() {
            try {
                ...
                else if (VerificaObrigatorio('#<%=txtInvoiceNo.ClientID%>', '#Avisos') == false) {
                    $("#Avisos").fadeOut(6000);
                    return false;
                }
