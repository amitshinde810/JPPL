<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="TrayDCReturn.aspx.cs"
    Inherits="Transactions_ADD_TrayDCReturn" Title="Tray DC Return" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Tray Delivery Challan Return
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            <div class="form-horizontal">
                                <div class="form-body">
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanele7" runat="server">
                                                            <ContentTemplate>
                                                                <div class="input-group">
                                                                    <asp:DropDownList ID="ddlType" CssClass="select2" Width="250px" runat="server" TabIndex="7"
                                                                        AutoPostBack="True" OnSelectedIndexChanged="ddlType_SelectedIndexChanged" Visible="false">
                                                                        <asp:ListItem Selected="True" Value="DCTIN">Tray Delivary Challan</asp:ListItem>
                                                                        <asp:ListItem Value="DCIN">Delivary Challan</asp:ListItem>
                                                                    </asp:DropDownList>
                                                                </div>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                    ...
                                    <div class="row" id="OCHNO" visible="false" runat="server">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label text-right ">
                                                ...
                                                <div id="Div3" class="col-md-1 " visible="false" runat="server">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div id="Div4" class="col-md-1" visible="false" runat="server">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel21" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass=" form-control text-right" ID="txtStock" TabIndex="12" runat="server"
                                                                MsgObrigatorio="Stock" placeholder="Stock" Text="0.00" AutoPostBack="True" Enabled="false"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel24" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox AutoPostBack="true" CssClass="form-control text-right" ID="txtOrderQty"
                                                                Text="0.000" TabIndex="11" MsgObrigatorio="Order Qty." onkeypress="return validateFloatKeyPress(this,event);"
                                                                placeholder="Order Qty" runat="server" OnTextChanged="txtOrderQty_TextChanged"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox AutoPostBack="true" CssClass="form-control text-right" ID="txtScrapQty"
                                                                Text="0.000" TabIndex="11" onkeypress="return validateFloatKeyPress(this,event);"
                                                                MsgObrigatorio="Scrap Qty." placeholder="Scrap Qty" runat="server" OnTextChanged="txtScrapQty_TextChanged"></asp:TextBox>
