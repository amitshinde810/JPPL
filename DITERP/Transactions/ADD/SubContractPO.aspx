...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
                        ...
                        <div class="portlet-body form">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">
                                                            Project Code</label>
                                                        <div class="col-md-4">
                                                            <asp:UpdatePanel ID="UpdatePanfel59" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList ID="ddlProjectCode" Width="100%" MsgObrigatorio="Project Code"
                                                                        AutoPostBack="true" CssClass="select2" runat="server">
                                                                    </asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                            <ContentTemplate>
                                                                <asp:DropDownList ID="ddlRateUOM" CssClass="select2" Width="100%" runat="server"
                                                                    TabIndex="11" MsgObrigatorio="Please Select Item Name" AutoPostBack="true" OnSelectedIndexChanged="ddlRateUOM_SelectedIndexChanged">
                                                                </asp:DropDownList>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                                    </div>
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel17" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:TextBox CssClass="form-control" ID="txtTranspoter" placeholder=" Delivery Inst"
                                                                        TabIndex="25" runat="server" Text="DELIVERY    AT  "></asp:TextBox>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </div>
                                                    </div>
                            ...
                            <asp:UpdatePanel runat="server" ID="UpdatePanel39">
                                <ContentTemplate>
                                    ...
                                    <asp:Panel ID="PopDocument" runat="server" Style="display: none; width: 80%; height: 80%">
                                            ...
                                            <div class="portlet-body form">
                                                <div class="form-horizontal">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <iframe runat="server" id="IframeViewPDF" style="width: 100%; height: 400px"></iframe>
                                                            </div>
                                                        </div>
                                                        <div class="row">
    ...
    <!-- BEGIN JAVASCRIPTS(Load
    javascripts at bottom, this will reduce page load time)-->
    <!-- BEGIN CORE PLUGINS -->
