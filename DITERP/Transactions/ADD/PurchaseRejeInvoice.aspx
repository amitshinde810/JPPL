<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="PurchaseRejeInvoice.aspx.cs"
    Inherits="Transactions_ADD_PurchaseRejeInvoice" Title="Purchase Rejection Invoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Purchase Rejection Invoice
                            </div>
                            <div class="tools">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <asp:UpdatePanel ID="UpdatePanel17" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlSupplier" AutoPostBack="true" OnSelectedIndexChanged="ddlddlSupplier_SelectedIndexChanged"
                                                                CssClass="select2_category form-control" runat="server" MsgObrigatorio="Customer"
                                                                TabIndex="1">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        <asp:TextBox CssClass="form-control" placeholder="dd MMM yyyy" ID="txtDate" TabIndex="2"
                                                            runat="server" MsgObrigatorio="Invoice Date" TextMode="SingleLine" ReadOnly="false"></asp:TextBox>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlItemCode" CssClass="select2_category form-control input-sm"
                                                                runat="server" TabIndex="5" AutoPostBack="True" MsgObrigatorio="Item Code" OnSelectedIndexChanged="ddlItemCode_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlItemName" CssClass="select2_category form-control input-sm"
                                                                runat="server" TabIndex="6" AutoPostBack="True" MsgObrigatorio="Item Name" OnSelectedIndexChanged="ddlItemName_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="control-label label-sm">
                                                        <span class="required"></span>Purchase No</label>
                                                    <asp:UpdatePanel ID="UpdatePanell43" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlPurchaseNo" AutoPostBack="true" CssClass="select2_category form-control"
                                                                runat="server" MsgObrigatorio="Customer" TabIndex="1" OnSelectedIndexChanged="ddlPurchaseNo_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel18" runat="server" UpdateMode="Conditional">
                                                        ...
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="ddlItemName" EventName="SelectedIndexChanged" />
                                                            <asp:AsyncPostBackTrigger ControlID="ddlPurchaseNo" EventName="SelectedIndexChanged" />
                                                            <asp:AsyncPostBackTrigger ControlID="dgInvoiceAddDetail" EventName="RowCommand" />
                                                            <asp:AsyncPostBackTrigger ControlID="btnInsert" EventName="Click" />
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="control-label  label-sm">
                                                        <span class="required"></span>No. Of Packeges</label>
                                                    ...
                                                    <ContentTemplate>
                                                        <asp:GridView ID="dgInvoiceAddDetail" runat="server" TabIndex="20" Style="width: 100%;"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="No Of Packcks" SortExpression="NoOfPackes" Visible="true"
                                                                    HeaderStyle-HorizontalAlign="Left">
                                                                    <ItemTemplate>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <asp:TextBox CssClass="form-control input-sm" ID="txtstroreloc" placeholder="Store Location"
                                                        TabIndex="21" runat="server" MaxLength="150" Visible="false"></asp:TextBox>
                                                </div>
                                                <label class="col-md-2 control-label label-sm">
                                                    Basic Amount
                                                </label>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel9" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox Visible="true" CssClass="form-control text-right input-sm" ID="txtBasicExcPer"
                                                                placeholder="0.00" TabIndex="30" runat="server" AutoPostBack="true" Text="12.00"
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel10" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox Visible="true" CssClass="form-control text-right input-sm" ID="txtducexcper"
                                                                placeholder="0.00" TabIndex="33" runat="server" Text="2.00" OnTextChanged="txtducexcper_TextChanged"
                                                                AutoPostBack="true"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel11" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox Visible="true" CssClass="form-control text-right input-sm" ID="txtSHEExcPer"
                                                                placeholder="0.00" TabIndex="36" AutoPostBack="true" runat="server" Text="1.00"
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel14" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlTaxName" CssClass="select2_category form-control input-sm"
                                                                Enabled="false" runat="server" TabIndex="40" AutoPostBack="True" OnSelectedIndexChanged="ddlTaxName_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="btnInsert" EventName="Click" />
    ...
    <script type="text/javascript">
        function VerificaCamposObrigatorios() {
            try {
                if (VerificaObrigatorio('#<%=ddlSupplier.ClientID%>', '#Avisos') == false) {
                    $("#Avisos").fadeOut(6000);
                    return false;
                }
