<%@ Page Title="Issue From Main Store" Language="C#" MasterPageFile="~/main.master"
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Issue From Main Store
                            </div>
                            <div class="tools">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                        <asp:RadioButtonList ID="rbtWithAmt"   runat="server" AutoPostBack="True"
                                                                ...
                                                                <asp:ListItem Value="-2147483647" Selected="True">&nbsp; Main Store Plant 1&nbsp;&nbsp;</asp:ListItem>
                                                                <asp:ListItem Value="-2147483634">&nbsp;Main Store Plant 2</asp:ListItem>
                                                            </asp:RadioButtonList>
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                                    ...
                                                    <ContentTemplate>
                                                        <div class="col-md-3">
                                                            <asp:TextBox ID="txtIssueBy" runat="server" CssClass="form-control" placeholder="Issue by"
                                                                MaxLength="40" TabIndex="4" MsgObrigatorio="Please Enter Issue By"></asp:TextBox>
                                                    </ContentTemplate>
                                                    <Triggers>
                                            ...
                                            <div class="col-md-4">
                                                <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="txtReqPerson" CssClass="select2" Width="100%" runat="server"
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                                                            <ContentTemplate>
                                                                <asp:DropDownList ID="ddlCategory" CssClass="select2" Width="100%" runat="server"
                                                                    TabIndex="6" OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged" MsgObrigatorio="Item Code"
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                                            <ContentTemplate>
                                                                <asp:TextBox CssClass="form-control text-right input-sm" Width="90%" ID="txtRequiredQty"
                                                                    MsgObrigatorio="Required Qty" placeholder="0.000" TabIndex="9" AutoPostBack="true"
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                            <ContentTemplate>
                                                                <asp:TextBox CssClass="form-control text-right input-sm" Width="90%" ID="txtIssueQty"
                                                                    placeholder="0.000" TabIndex="9" runat="server" MsgObrigatorio="Please Enter Issue Qty"
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                                            <ContentTemplate>
                                                                <asp:TextBox CssClass="form-control" ID="txtRemark" Width="90%" placeholder=" Remark"
                                                                    MaxLength="40" TabIndex="10" runat="server"></asp:TextBox></ContentTemplate>
                                                        </asp:UpdatePanel>
                                                    </div>
                                                </div>
