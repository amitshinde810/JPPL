                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel43" runat="server">
                                                            <ContentTemplate>
                                                                <asp:TextBox CssClass="form-control input-sm" ID="txtVehNo" placeholder="Vehicle No"
                                                                    TabIndex="3" MaxLength="30" runat="server"></asp:TextBox>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                                    </div>
                                                </div>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel44" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control input-sm" ID="txtCreditDays" placeholder="Credit Days"
                                                                TabIndex="3" MaxLength="10" runat="server"></asp:TextBox>
                                                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" TargetControlID="txtCreditDays"
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel46" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control input-sm" ID="txtPreparedBy" placeholder="Prepared By"
                                                                MaxLength="200" TabIndex="3" runat="server"></asp:TextBox>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        <asp:UpdatePanel ID="UpdatePanel47" runat="server">
                                                            <ContentTemplate>
                                                                <asp:TextBox CssClass="form-control input-sm" ID="txtSpecialInst" MaxLength="200"
                                                                    placeholder="Special Inst" TabIndex="3" runat="server"></asp:TextBox>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel ID="UpdatePanel48" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control input-sm" ID="txtNatureProcess" MaxLength="200"
                                                                placeholder="Nature Process" TabIndex="3" runat="server"></asp:TextBox>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlPONo" CssClass="select2_category form-control input-sm"
                                                                Width="100%" runat="server" TabIndex="7" AutoPostBack="True" MsgObrigatorio="PO Number"
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="control-label label-sm">
                                                        <span class="required">*</span> Store</label>
                                                    <asp:UpdatePanel ID="UpdatePanel8" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlStore" CssClass="select2" Width="100%" runat="server" TabIndex="7"
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel9" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtScheduleQty" placeholder="0.000"
                                                                runat="server" AutoPostBack="true" ReadOnly="true" TabIndex="9"></asp:TextBox>
                                                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" TargetControlID="txtScheduleQty"
                                                                ValidChars="0123456789.-" runat="server" />
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="ddlStore" EventName="SelectedIndexChanged" />
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel24" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtVQty" Text="0.000"
                                                                onkeypress="return validateFloatKeyPress(this,event);" MaxLength="10" placeholder="0.000"
                                                                TabIndex="11" runat="server" AutoPostBack="true" OnTextChanged="txtVQty_TextChanged"
                                                                MsgObrigatorio="Disp Qty"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel29" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtConvertQty" placeholder="Convert Qty."
                                                                ...
                                                                MaxLength="20" onkeypress="return validateFloatKeyPress(this,event);"></asp:TextBox>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="ddlItemCode" EventName="SelectedIndexChanged" />
                                                            <asp:AsyncPostBackTrigger ControlID="ddlItemName" EventName="SelectedIndexChanged" />
                                                    ...
                                                    <ContentTemplate>
                                                        <asp:GridView ID="dgInvoiceAddDetail" runat="server" TabIndex="20" Style="width: 100%;"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="StoreCode" SortExpression="temCode" Visible="False">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblST_CODE" runat="server" Text='<%# Bind("IND_STORE_CODE") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Store Name" SortExpression="ItemCode" Visible="True">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblST_NAME" runat="server" Text='<%# Bind("IND_STORE_NAME") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
