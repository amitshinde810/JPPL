                                            ...
                                            <div class="form-group">
                                                <label class=" col-md-2 control-label text-right ">
                                                    Order No.</label><div class="col-md-3 ">
                                                        <asp:TextBox ID="txtOrderNo" MaxLength="20" runat="server" placeholder="Order Number"
                                                            CssClass="form-control" ValidationGroup="Save" TabIndex="4"></asp:TextBox>
                                                    </div>
                                                <label class=" col-md-2 control-label text-right ">
                                                    Invoice No.</label><div class="col-md-2 ">
                                                        <asp:TextBox ID="txtInvoiceNo" MaxLength="20" runat="server" placeholder="Invoice Number"
                                                            CssClass="form-control" ValidationGroup="Save" TabIndex="4"></asp:TextBox>
                                                    </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <label class=" col-md-2 control-label text-right ">
                                                    Vehicle No.</label><div class="col-md-3 ">
                                                        <asp:TextBox ID="txtVehicleNo" MaxLength="20" runat="server" placeholder="Vehicle Number"
                                                            CssClass="form-control" ValidationGroup="Save" TabIndex="4"></asp:TextBox>
                                                    </div>
                                                <label class=" col-md-2 control-label text-right ">
                                                    L.R. No.</label><div class="col-md-2 ">
                                                        <asp:TextBox ID="txtLRno" MaxLength="20" runat="server" placeholder="L.R Number"
                                                            CssClass="form-control" ValidationGroup="Save" TabIndex="4"></asp:TextBox>
                                                    </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class=" col-md-2 control-label text-right ">
                                                    Through</label><div class="col-md-3 ">
                                                        <asp:TextBox ID="txtThrough" runat="server" MaxLength="20" placeholder="Through"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlStore" CssClass="select2" Width="100%" Enabled="false" OnSelectedIndexChanged="ddlStore_SelectedIndexChanged"
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel21" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass=" form-control text-right" ID="txtStock" TabIndex="12" runat="server"
                                                                MsgObrigatorio="Stock" MaxLength="20" placeholder="Stock" AutoPostBack="True"
