<%@ Page Title="Batch Ticket" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewBatchTicket.aspx.cs" Inherits="Transactions_VIEW_ViewBatchTicket" %>
                        ...
                        <div class="portlet-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-body">
                                    <div class="btn-group">
                                        <label class="control-label">
                                            Total Batch Ticket No :
                                        </label>
                                    </div>
                                    <div class="btn-group">
                                        <br />
                                        <asp:Label ID="lblBT_NO_Count" runat="server" CssClass="control-label "></asp:Label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <asp:LinkButton ID="lnkbtnformoreinfo" runat="server" OnClick="lnkbtnformoreinfo_Click">For More Info</asp:LinkButton>
                                    </div>
                                </div>
                                <br />
                                <div class="row">
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                                <ContentTemplate>
                                                    <asp:GridView ID="dgBatch" runat="server" Width="100%" AutoGenerateColumns="False"
                                                        ...
                                                        CssClass="table table-striped table-bordered table-advance table-hover" DataKeyNames="BT_CODE"
                                                        ...
                                                        <Columns>
                                                                            ...
                                                                            <ul class="dropdown-menu" role="menu">
                                                                                <li>
                                                                                    <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                                        Text="View" CommandArgument='<%# Bind("BT_CODE") %>'><i class="fa fa-search"></i> View</asp:LinkButton>
                                                                                </li>
                                                                                <li>
                                                                                    <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                                        Text="Modify" CommandArgument='<%# Bind("BT_CODE") %>'><i class="fa fa-edit"></i> Modify</asp:LinkButton>
                                                                                </li>
                                                                                <li>
                                                                                ...
                                                                                <li>
                                                                                    <asp:LinkButton ID="lnkPrint" runat="server" CausesValidation="False" CommandName="Print"
                                                                                        Text="Print" CommandArgument='<%# Bind("BT_CODE") %>'><i class="fa fa-print"></i> Print</asp:LinkButton></li>
                                                                            </ul>
                                                                        </div>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="BT_CODE" SortExpression="BT_CODE" Visible="false">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Batch Date" SortExpression="BT_DATE" HeaderStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblBT_DATE" CssClass="" runat="server" Text='<%# Eval("BT_DATE") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Formula Code" SortExpression="SHM_FORMULA_CODE" HeaderStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSHM_FORMULA_CODE" CssClass="" runat="server" Text='<%# Eval("SHM_FORMULA_CODE") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Authorized" SortExpression="BT_IS_AUTHORISE" HeaderStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnkPost" CssClass='<%# (Convert.ToString(Eval("BT_IS_AUTHORISE"))=="true")? "btn default btn-xs":"btn blue btn-xs" %>'
                                                                        BorderStyle="None" runat="server" CausesValidation="False" CommandName="Post"
                                                                        Text="Post" Enabled='<%# (Convert.ToString(Eval("BT_IS_AUTHORISE"))=="true")?Convert.ToBoolean("false"):Convert.ToBoolean("true") %>'
                                                                        CommandArgument='<%# Bind("BT_CODE") %>'><i class="fa fa-lock"></i> Authorized</asp:LinkButton>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" CssClass="text-left" Width="120px" />
                                                            </asp:TemplateField>
                                                        </Columns>
