<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewMaterialRequisition.aspx.cs"
    Inherits="Transactions_VIEW_ViewMaterialRequisition" Title="Material Requisition" %>
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="dgMaterialRequsition" runat="server" AutoGenerateColumns="False"
                                        Width="100%" CellPadding="4" Font-Size="12px" Font-Names="Verdana" GridLines="Both"
                                        DataKeyNames="MR_CODE" CssClass="table table-striped table-bordered table-advance table-hover"
                                        AllowPaging="True" OnRowCommand="dgMaterialRequsition_RowCommand" OnRowDeleting="dgMaterialRequsition_RowDeleting"
                                        OnPageIndexChanging="dgMaterialRequsition_PageIndexChanging" PageSize="15">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="MR_I_CODE" SortExpression="MR_I_CODE" HeaderStyle-HorizontalAlign="Left"
                                                Visible="false">
                                                <ItemTemplate>
