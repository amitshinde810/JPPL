<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewLabourChargeInvoiceNew.aspx.cs"
    Inherits="Transactions_VIEW_ViewLabourChargeInvoiceNew" Title="Labour Charge - View" %>
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="dgInvoice" runat="server" AutoGenerateColumns="False" Width="100%"
                                        CellPadding="4" Font-Size="12px" Font-Names="Verdana" GridLines="Both" DataKeyNames="LIM_CODE"
                                        CssClass="table table-striped table-bordered table-advance table-hover" AllowPaging="True"
                                        OnRowEditing="dgInvoice_RowEditing" OnRowCommand="dgInvoice_RowCommand" OnRowDeleting="dgInvoice_RowDeleting"
                                        OnPageIndexChanging="dgInvoice_PageIndexChanging" PageSize="15">
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                        Text="View" CommandArgument='<%# Bind("LIM_CODE") %>'><i class="fa fa-search"></i> View</asp:LinkButton>
                                                                </li>
                                                                <li>
                                                                    <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                        Text="Modify" CommandArgument='<%# Bind("LIM_CODE") %>'><i class="fa fa-edit"></i> Modify</asp:LinkButton>
                                                                </li>
                                                                <li>
                                                                 ...
                                                                 <li>
                                                                    <asp:LinkButton ID="lnkPrint" runat="server" CausesValidation="False" CommandName="Print"
                                                                        Text="Print" CommandArgument='<%# Bind("LIM_CODE") %>'><i class="fa fa-print"></i> Print</asp:LinkButton>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                            ...
                                            <asp:TemplateField HeaderText="LIM_CODE" SortExpression="LIM_CODE" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblLIM_CODE" CssClass="formlabel" runat="server" Text='<%# Bind("LIM_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Bill Number" SortExpression="BPM_NO" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblLIM_NO" runat="server" Text='<%# Eval("LIM_NO") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Bill Date" SortExpression="BPM_DATE" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblLIM_DATE" runat="server" Text='<%# Eval("LIM_DATE") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="LIM_P_CODE" SortExpression="BPM_P_CODE" HeaderStyle-HorizontalAlign="Left"
                                                Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblLIM_P_CODE" runat="server" Text='<%# Eval("LIM_P_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6" >
                                                        <asp:UpdatePanel runat="server" ID="UpdatePanelgf7">
                                                            <ContentTemplate>
                                                                <asp:CheckBox runat="server"  Visible="false" ID="chlSupp" Text="&nbspSuppliementory Invoice" CssClass="checker" />
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-1">
                                                        <asp:UpdatePanel runat="server" ID="UpdatePuiu">
                                                            <ContentTemplate>
                                                                <asp:RadioButtonList runat="server" ID="rbtPrintCopyList" RepeatDirection="Horizontal" OnCheckedChanged="chk1_CheckedChanged"
                                                                     CssClass="checker">
