...
public partial class Transactions_VIEW_ViewCashInward : System.Web.UI.Page
{
    #region Variable
    ...
    protected void btnAddNew_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string type = "INSERT";
                Response.Redirect("~/Transactions/ADD/CashInward.aspx?c_name=" + type, false);
            }
            else
            {
    ...
    protected void dgDetailPO_RowEditing(object sender, GridViewEditEventArgs e)
    {
        try
        {
            if (CommonClasses.ValidRights(int.Parse(right.Substring(2, 1)), this, "For Modify"))
            {
                ...
                {
                    Response.Redirect("~/Transactions/ADD/CashInward.aspx?c_name=" + type + "&cpom_code=" + cpom_code, false);
                }
            }
            else
            {
