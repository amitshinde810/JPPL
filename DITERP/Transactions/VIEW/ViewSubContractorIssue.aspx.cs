                    ...
                    else
                    {
                        ...
                        if (flag == true)
                        {
                            ...
                            for (int i = 0; i < dtq.Rows.Count; i++)
                            {
                                ...
                                CommonClasses.Execute("DELETE from STOCK_LEDGER WHERE STL_DOC_NO='" + cpom_code + "' AND STL_I_CODE='" + dtq.Rows[i]["IWD_I_CODE"] + "'  ");
                            }
                            ...
                            CommonClasses.Execute("DELETE from STOCK_LEDGER WHERE STL_DOC_NO='" + cpom_code + "' and STL_DOC_TYPE='SUBINWARD'");
