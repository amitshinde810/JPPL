<%@ Page Title="Stock Trasfer" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewStockTransfer.aspx.cs" Inherits="Transactions_VIEW_ViewStockTransfer" %>
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="dgStockAdjustment" runat="server" AutoGenerateColumns="False" Width="100%"
                                        CellPadding="4" Font-Size="12px" Font-Names="Verdana" GridLines="Both" DataKeyNames="STM_CODE"
                                        CssClass="table table-striped table-bordered table-advance table-hover" AllowPaging="True"
                                        OnRowEditing="dgStockAdjustment_RowEditing" OnRowCommand="dgStockAdjustment_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Code" SortExpression="Code" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCode" CssClass="formlabel" runat="server" Text='<%# Bind("STM_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Date" SortExpression="Date">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDate" CssClass="formlabel" runat="server" Text='<%# Bind("STM_DOC_DATE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Doc No." SortExpression="IM_CODE" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDoc_No" runat="server" Text='<%# Eval("STM_DOC_NO") %>'></asp:Label>
                                                </ItemTemplate>
