                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="btn-group pull-right">
                                                <asp:LinkButton ID="btnAddNewMulti" CssClass="btn green" runat="server" OnClick="btnAddNewMulti_Click">Add Multiple <i class="fa fa-plus"></i></asp:LinkButton>
                                            </div>
                                            <div class="btn-group pull-right">
                                                &nbsp&nbsp
                                                <asp:LinkButton ID="btnAddNew" Visible="false" CssClass="btn green" runat="server" OnClick="btnAddNew_Click">Add New  <i class="fa fa-plus"></i></asp:LinkButton>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                            <ContentTemplate>
                                                <asp:GridView ID="dgInvoiceDettail" runat="server" AutoGenerateColumns="False" Width="100%"
                                                    Font-Size="12px" Font-Names="Verdana" DataKeyNames="INM_CODE" CssClass="table table-striped table-bordered table-advance table-hover"
                                                    AllowPaging="True" OnRowCommand="dgInvoiceDettail_RowCommand" OnRowDeleting="dgInvoiceDettail_RowDeleting"
                                                    OnPageIndexChanging="dgInvoiceDettail_PageIndexChanging" PageSize="15" EnableTheming="True">
                                                    <Columns>
                                                                        ...
                                                                        <ContentTemplate>
                                                                            <asp:DropDownList runat="server" ID="ddlPrintOpt" CssClass="form-control" AutoPostBack="true"
                                                                                ...
                                                                                <asp:ListItem Value="3" Text="Excise Print"></asp:ListItem>
                                                                                 <asp:ListItem Value="4" Text="E Invoice Print"></asp:ListItem>
                                                                            </asp:DropDownList>
                                                                        </ContentTemplate>
                                                                    </asp:UpdatePanel>
                                                                </div>
