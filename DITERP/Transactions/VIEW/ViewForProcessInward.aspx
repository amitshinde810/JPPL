<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewForProcessInward.aspx.cs"
    Inherits="Transactions_VIEW_ViewForProcessInward" Title="For Process Inward" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>for Process Inward
                            </div>
                            <div class="tools">
