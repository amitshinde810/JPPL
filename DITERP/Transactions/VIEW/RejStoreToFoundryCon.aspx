<%@ Page Title="Casting Conversion" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="RejStoreToFoundryCon.aspx.cs" Inherits="Transactions_VIEW_RejStoreToFoundryCon" %>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="dgProductionStore" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        CssClass="table table-striped table-bordered table-advance table-hover" DataKeyNames="RTF_CODE"
                                        ...
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                        Text="View" CommandArgument='<%# Bind("RTF_CODE") %>'><i class="fa fa-search"></i> View</asp:LinkButton>
                                                                </li>
                                                                <li>
                                                                    <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                        Text="Modify" CommandArgument='<%# Bind("RTF_CODE") %>'><i class="fa fa-edit"></i> Modify</asp:LinkButton>
                                                                </li>
                                                                <li>
                                                                ...
                                                                <li>
                                                                    <asp:LinkButton ID="lnkPrint" runat="server" CausesValidation="False" CommandName="Print"
                                                                        Text="Print" CommandArgument='<%# Bind("RTF_CODE") %>'><i class="fa fa-print"></i> Print</asp:LinkButton></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="RTF_CODE" SortExpression="RTF_CODE" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPS_CODE" runat="server" Text='<%# Bind("RTF_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Doc No." SortExpression="RTF_DOC_NO" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRTF_DOC_NO" CssClass="" runat="server" Text='<%# Eval("RTF_DOC_NO") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Date" SortExpression="RTF_DOC_DATE" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRTF_DOC_DATE" CssClass="" runat="server" Text='<%# Eval("RTF_DOC_DATE") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                        </Columns>
