<%@ Page Title="Shade Creation" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewShadeCreation.aspx.cs" Inherits="Transactions_VIEW_ViewShadeCreation" %>
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                                <ContentTemplate>
                                                    <asp:GridView ID="dgCustomerEnquiry" runat="server" Width="100%" AutoGenerateColumns="False"
                                                        ...
                                                        CssClass="table table-striped table-bordered table-advance table-hover" DataKeyNames="SHM_CODE"
                                                        ...
                                                        <Columns>
                                                                            ...
                                                                            <ul class="dropdown-menu" role="menu">
                                                                                <li>
                                                                                    <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                                        Text="View" CommandArgument='<%# Bind("SHM_CODE") %>'><i class="fa fa-search"></i> View</asp:LinkButton>
                                                                                </li>
                                                                                <li>
                                                                                    <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                                        Text="Modify" CommandArgument='<%# Bind("SHM_CODE") %>'><i class="fa fa-edit"></i> Modify</asp:LinkButton>
                                                                                </li>
                                                                                <li>
                                                                                ...
                                                                                <li>
                                                                                    <asp:LinkButton ID="lnkPrint" runat="server" CausesValidation="False" CommandName="Print"
                                                                                        Text="Print" CommandArgument='<%# Bind("SHM_CODE") %>'><i class="fa fa-print"></i> Print</asp:LinkButton></li>
                                                                            </ul>
                                                                        </div>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="SHM_CODE" SortExpression="SHM_CODE" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSHM_CODE" runat="server" Text='<%# Bind("SHM_CODE") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Formula Name" SortExpression="SHM_FORMULA_NAME" HeaderStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSHM_FORMULA_NAME" CssClass="" runat="server" Text='<%# Eval("SHM_FORMULA_NAME") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:TemplateField>
                                                        </Columns>
