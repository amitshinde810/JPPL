<%@ Page Title="Material Inward" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewMaterialInward.aspx.cs" Inherits="Transactions_VIEW_ViewMaterialInward" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Material Inward
                            </div>
                            <div class="tools">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                ...
                                                                <li>
                                                                    <asp:LinkButton ID="lnkPrintMult" runat="server" CausesValidation="False" CommandName="PrintMult"
                                                                        Text="Print" CommandArgument='<%# Bind("IWM_CODE") %>'><i class="fa fa-print"></i> Print Multiple</asp:LinkButton>
                                                                </li>
                                                                <li>
