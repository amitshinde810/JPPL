<%@ Page Title="Supplier Audit" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewSupplierAudit.aspx.cs" Inherits="Transactions_VIEW_ViewSupplierAudit" %>
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="dgSuppAudit" runat="server" AutoGenerateColumns="False" Width="100%"
                                        CellPadding="4" Font-Size="12px" Font-Names="Verdana" GridLines="Both" DataKeyNames="SAM_CODE"
                                        CssClass="table table-striped table-bordered table-advance table-hover" AllowPaging="True"
                                        OnRowCommand="dgSuppAudit_RowCommand" OnRowDeleting="dgSuppAudit_RowDeleting"
                                        OnPageIndexChanging="dgSuppAudit_PageIndexChanging" PageSize="15">
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                ...
                                                                <li>
                                                                    <asp:LinkButton ID="lnkDelete" runat="server" CausesValidation="False" CommandName="Delete"
                                                                        ...
                                                                        CommandArgument='<%# Bind("SAM_CODE") %>'> <i class="fa fa-trash-o"></i> Delete</asp:LinkButton>
                                                                </li>
                                                                <li>
                                                                    <asp:LinkButton ID="lnkPrint" runat="server" CausesValidation="False" CommandName="Print"
                                                                        Text="Print" CommandArgument='<%# Bind("SAM_CODE") %>'><i class="fa fa-print"></i> Print</asp:LinkButton></li>
                                                                <li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                            ...
                                            <asp:TemplateField HeaderText="SAM_CODE" SortExpression="SAM_CODE" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSAM_CODE" CssClass="formlabel" runat="server" Text='<%# Bind("SAM_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText=" Month" SortExpression="SAM_FDATE" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSAM_FDATE" CssClass=" Control-label" runat="server" Text='<%# Eval("SAM_FDATE") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
