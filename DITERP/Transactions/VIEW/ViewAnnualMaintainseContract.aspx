<%@ Page Title="Annual Maintenance Contract" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewAnnualMaintainseContract.aspx.cs" Inherits="Transactions_VIEW_ViewAnnualMaintainseContract" %>
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="dgAMCDet" runat="server" AutoGenerateColumns="False" Width="100%"
                                        CellPadding="4" Font-Size="12px" Font-Names="Verdana" GridLines="Both" DataKeyNames="WO_AMC_CODE"
                                        CssClass="table table-striped table-bordered table-advance table-hover" AllowPaging="True"
                                        OnRowEditing="dgAMCDet_RowEditing" OnRowCommand="dgAMCDet_RowCommand" OnRowDeleting="dgAMCDet_RowDeleting"
                                        OnPageIndexChanging="dgAMCDet_PageIndexChanging" PageSize="15">
                                        <Columns>
