<%@ Page Title="Sales - Work Order" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewSaleWorkOrder.aspx.cs" Inherits="Transactions_VIEW_ViewSaleWorkOrder" %>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                ...
                                                                <li>
                                                                    <asp:LinkButton ID="lnkPrint" runat="server" CausesValidation="False" CommandName="Print"
                                                                        Visible="false" Text="Print" CommandArgument='<%# Bind("WO_CODE") %>'><i class="fa fa-print"></i> Print Sale Order</asp:LinkButton></li>
                                                                <li>
                                                                    <asp:LinkButton ID="lnkPrint1" runat="server" CausesValidation="False" CommandName="PrintWork"
                                                                        Text="Print" CommandArgument='<%# Bind("WO_CODE") %>'><i class="fa fa-print"></i> Print</asp:LinkButton>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
