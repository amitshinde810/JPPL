<%@ Page Title="Work Order" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewAMCWorkOrder.aspx.cs" Inherits="Transactions_VIEW_ViewAMCWorkOrder" %>
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="dgWODetails" runat="server" AutoGenerateColumns="False" Width="100%"
                                        CellPadding="4" Font-Size="12px" Font-Names="Verdana" GridLines="Both" DataKeyNames="WO_AMC_CODE"
                                        CssClass="table table-striped table-bordered table-advance table-hover" AllowPaging="True"
                                        OnRowEditing="dgWODetails_RowEditing" OnRowCommand="dgWODetails_RowCommand" OnRowDeleting="dgWODetails_RowDeleting"
                                        OnPageIndexChanging="dgWODetails_PageIndexChanging" PageSize="15">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="WO No" SortExpression="WO_AMC_CODE" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Amount" SortExpression="WO_AMC_CODE" HeaderStyle-HorizontalAlign="Right">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblWO_GRAND_TOT" CssClass=" Control-label pull-right" runat="server"
                                                        Text='<%# Eval("WO_GRAND_TOT") %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Amend" SortExpression="WO_AM_COUNT" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblWO_AM_COUNT" CssClass=" Control-label pull-left" runat="server"
                                                        Text='<%# Eval("WO_AM_COUNT") %>'></asp:Label>
                                                </ItemTemplate>
