                                ...
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <asp:DropDownList ID="ddlFilter" CssClass="select2" Width="100%" runat="server" AutoPostBack="true"
                                                    TabIndex="2" OnSelectedIndexChanged="ddlFilter_SelectedIndexChanged">
