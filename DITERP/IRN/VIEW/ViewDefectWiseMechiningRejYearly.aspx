<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewDefectWiseMechiningRejYearly.aspx.cs"
    Inherits="IRN_VIEW_ViewDefectWiseMechiningRejYearly" Title="Defect Wise Machining Rejection Yearly" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>COMPONENT SPECIFIC DEFECT SPECIFIC MONTH WISE MACHINING
                                REJECTION DETAILS
                            </div>
                            <div class="tools">
