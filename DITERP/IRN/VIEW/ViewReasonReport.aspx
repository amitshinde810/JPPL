<%@ Page Title="Short Production Reason Report" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewReasonReport.aspx.cs" Inherits="RoportForms_VIEW_ViewReasonReport" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Short Production Reason Report
                            </div>
                            <div class="tools">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel9">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlReason" runat="server" placeholder="Select Reason" AutoPostBack="True"
