...
public partial class IRN_VIEW_ViewRejectiondetails : System.Web.UI.Page
{
    static string right = "";
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommonClasses.ValidRights(int.Parse(right.Substring(0, 5)), this, "For Menu"))
            {
                ...
                Response.Redirect("../../IRN/ADD/Rejectiondetails.aspx?Title=" + Title + "&FDATE=" + txtFromDate.Text + "&TDATE=" + txtTodate.Text + "&i_name=" + ddlFinishedComponent.SelectedValue.ToString() + "", false);
            }
            else
            {
