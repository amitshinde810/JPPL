<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewCompWiseReport.aspx.cs"
    Inherits="IRN_VIEW_ViewCompWiseReport" Title="Component Stage wise Report" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Component Stage wise Report
                            </div>
                            <div class="tools">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel14">
                                                        <ContentTemplate>
                                                            <asp:RadioButtonList ID="rbType" runat="server" RepeatDirection="Horizontal" CssClass="checker"
                                                                CellPadding="10" AutoPostBack="true" OnSelectedIndexChanged="rbType_SelectedIndexChanged">
                                                                <asp:ListItem Value="0" Selected="True">Monthly Report</asp:ListItem>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel7">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlLine" runat="server" AutoPostBack="True" CssClass="select2"
                                                                Width="100%" TabIndex="9" OnSelectedIndexChanged="ddlLine_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                ...
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel9">
                                                        <ContentTemplate>
                                                            <asp:CheckBox ID="chKLine" runat="server" CssClass="checker" Text="&nbspAll" AutoPostBack="True"
                                                                TabIndex="10" OnCheckedChanged="chKLine_CheckedChanged" />
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel4">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlStage" runat="server" AutoPostBack="True" CssClass="select2"
                                                                Width="100%" TabIndex="9" OnSelectedIndexChanged="ddlStage_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="chkStgae" EventName="CheckedChanged" />
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                </div>
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel6">
                                                        <ContentTemplate>
                                                            <asp:CheckBox ID="chkStgae" runat="server" CssClass="checker" Text="&nbspAll" AutoPostBack="True"
                                                                TabIndex="10" OnCheckedChanged="chkStgae_CheckedChanged" />
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel10">
                                                        <ContentTemplate>
                                                            <asp:RadioButtonList ID="rbSelType" runat="server" RepeatDirection="Horizontal" CssClass="checker"
                                                                CellPadding="10" AutoPostBack="true">
                                                                <asp:ListItem Value="0" Selected="True">Nos </asp:ListItem>
