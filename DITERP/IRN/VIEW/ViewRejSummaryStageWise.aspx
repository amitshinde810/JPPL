<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewRejSummaryStageWise.aspx.cs"
    Inherits="IRN_VIEW_ViewRejSummaryStageWise" Title="Rejection Summary Stage Wise" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Rejection Summary Stage Wise
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            <div class="form-horizontal">
                                <div class="form-body">
                                    <div class="row" id="aa" runat="server" visible="false">
                                        <div class="col-md-12">
                                                        ...
                                                        <ContentTemplate>
                                                            <div class="input-group">
                                                                ...
                                                                <cc1:CalendarExtender ID="CalendarExtender1" BehaviorID="calendar2" runat="server"
                                                                    Enabled="True" TargetControlID="txtToDate" OnClientHidden="onCalendarHidden2"
                                                                    OnClientShown="onCalendarShown2" PopupButtonID="txtToDate" Format="MMM yyyy">
                                                                </cc1:CalendarExtender>
                                                            </div>
                                                        </ContentTemplate>
                                                        <Triggers>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel6">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlDefect" runat="server" AutoPostBack="True" CssClass="select2"
                                                                Width="100%" TabIndex="9">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="chkAllDefect" EventName="CheckedChanged" />
                                                            <asp:AsyncPostBackTrigger ControlID="ddlItemCode" EventName="SelectedIndexChanged" />
                                                            <asp:AsyncPostBackTrigger ControlID="txtFromDate" EventName="TextChanged" />
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                ...
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel7">
                                                        <ContentTemplate>
                                                            <asp:CheckBox ID="chkAllDefect" runat="server" CssClass="checker" Text="&nbspAll"
                                                                AutoPostBack="True" TabIndex="10" OnCheckedChanged="chkAllDefect_CheckedChanged" />
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
                                                    ...
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel29">
                                                        <ContentTemplate>
                                                            <asp:RadioButtonList RepeatDirection="Horizontal" CssClass="checker" ID="tbType"
                                                                runat="server">
                                                                <asp:ListItem Value="0" Selected="True">&nbsp Nos. &nbsp&nbsp&nbsp</asp:ListItem>
                                                                <asp:ListItem Value="1">&nbsp Rs. &nbsp&nbsp&nbsp</asp:ListItem>
                                                                <asp:ListItem Value="2">&nbsp Per(%).</asp:ListItem>
                                                            </asp:RadioButtonList>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
