<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewDefectWiseFoundryRejYearly.aspx.cs"
    Inherits="IRN_VIEW_ViewDefectWiseFoundryRejYearly" Title="Defect Wise Foundry Rejection Yearly" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>COMPONENT SPECIFIC DEFECT SPECIFIC MONTH WISE FOUNDRY
                                REJECTION DETAILS
                            </div>
                            <div class="tools">
