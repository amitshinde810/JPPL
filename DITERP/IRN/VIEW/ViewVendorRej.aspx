<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewVendorRej.aspx.cs"
    Inherits="IRN_VIEW_ViewVendorRej" Title="Vendor Wise Rejection Yearly" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Vendor Wise Rejection Yearly
                            </div>
                            <div class="tools">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel13">
                                                        ...
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="ddlCustomerName" EventName="" />
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
