<%@ Page Title="Effectiveness Of The CAPA" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewIRNCustRejectionReport8D.aspx.cs" Inherits="RoportForms_VIEW_ViewIRNCustRejectionReport8D" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    ...
    <script type="text/javascript">
        ...
        Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(function(evt, args) {
            ...
            jQuery("#<%=ddlDefObserv.ClientID %>").select2();
        });
    </script>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Effectiveness Of The CAPA
                            </div>
                            <div class="tools">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel6">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlDefObserv" runat="server" AutoPostBack="True" CssClass="select2"
                                                        ...
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="ddlFinishedComponent" EventName="SelectedIndexChanged" />
                                                            <asp:AsyncPostBackTrigger ControlID="ddlCustomerName" EventName="SelectedIndexChanged" />
                                                            <asp:AsyncPostBackTrigger ControlID="chkAllDefObserv" EventName="CheckedChanged" />
                                                            <asp:AsyncPostBackTrigger ControlID="ddlItemCode" EventName="SelectedIndexChanged" />
                                                            <asp:AsyncPostBackTrigger ControlID="txtFromDate" EventName="TextChanged" />
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                ...
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel7">
                                                        <ContentTemplate>
                                                            <asp:CheckBox ID="chkAllDefObserv" runat="server" CssClass="checker" Text="&nbspAll"
                                                                AutoPostBack="True" TabIndex="10" OnCheckedChanged="chkAllDefObserv_CheckedChanged" />
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="ddlDefObserv" EventName="SelectedIndexChanged" />
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
