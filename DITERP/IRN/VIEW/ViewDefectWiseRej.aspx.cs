...
public partial class IRN_VIEW_ViewDefectWiseRej : System.Web.UI.Page
{
    static string right = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (CommonClasses.ValidRights(int.Parse(right.Substring(0, 1)), this, "For Menu"))
            {
                ...
                txtTodate.Text = Convert.ToDateTime(System.DateTime.Now).ToString("dd/MMM/yyyy");
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommonClasses.ValidRights(int.Parse(right.Substring(0, 5)), this, "For Menu"))
            {
                ...
                Response.Redirect("../../IRN/ADD/DefectWiseRej.aspx?Title=" + Title + "&FDATE=" + txtFromDate.Text + "&TDATE=" + txtTodate.Text + "&i_name=" + ddlFinishedComponent.SelectedValue.ToString() + "&type=" + tbType.SelectedValue.ToString() + "", false);
            }
            else
            {
