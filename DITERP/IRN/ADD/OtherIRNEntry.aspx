<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="OtherIRNEntry.aspx.cs"
    Inherits="IRN_ADD_OtherIRNEntry" Title="Other IRN Entry" %>
                                ...
                                <div class="form-body">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-2 control-label text-right">
                                                    <font color="red">*</font> IRN Date.</label>
                                                <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlStage" runat="server" TabIndex="1" CssClass="select2" Width="100%"
                                                ...
                                                <label class="col-md-1 control-label text-right">
                                                    <span class="required">*</span> Party Name
                                                </label>
                                                <div class="col-md-3">
                                                    <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlParty" runat="server" TabIndex="1" CssClass="select2" Width="100%"
                                                                AutoPostBack="True">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <label class="col-md-1 control-label text-right">
                                                    <span class="required">*</span> Defect Name
                                                </label>
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel ID="UpdatePanedl5" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlDefect" runat="server" TabIndex="1" CssClass="select2" Width="100%"
                                                                AutoPostBack="True">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtProdQty" placeholder="0.000"
                                                                runat="server" Text="0" MaxLength="15" onkeypress="return validateFloatKeyPress(this,event);"
                                                ...
                                                <label class="col-md-1 control-label text-right">
                                                    <span class="required">*</span> Rejection Qty
                                                </label>
                                                <div class="col-md-1">
                                                        ...
                                                        <asp:GridView ID="dgIRN" runat="server" Width="100%" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Type" SortExpression="IRND_TYPE" HeaderStyle-HorizontalAlign="Left"
                                                                    Visible="true">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblIRND_TYPE1" CssClass="" runat="server" Visible="True" Text='<%# Eval("IRND_TYPE1") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Left" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Party" SortExpression="IRND_P_CODE" HeaderStyle-HorizontalAlign="Left"
                                                                    Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblIRND_P_CODE" CssClass="" runat="server" Visible="True" Text='<%# Eval("IRND_P_CODE") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Left" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Party" SortExpression="P_NAME" HeaderStyle-HorizontalAlign="Left"
                                                                    Visible="True">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblP_NAME" CssClass="" runat="server" Visible="True" Text='<%# Eval("P_NAME") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Left" />
                                                                </asp:TemplateField>
