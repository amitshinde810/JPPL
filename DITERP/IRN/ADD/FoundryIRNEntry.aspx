<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="FoundryIRNEntry.aspx.cs"
    Inherits="IRN_ADD_FoundryIRNEntry" Title="Foundry IRN Entry" %>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtProdQty" placeholder="0.000"
                                                                runat="server" Text="0.00" MaxLength="15" onkeypress="return validateFloatKeyPress(this,event);"
