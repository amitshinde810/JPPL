<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="StageChange.aspx.cs"
    Inherits="IRN_ADD_StageChange" Title="Stages Change" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Component Stages Change
                            </div>
                            <div class="tools">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label text-right">
                                                    <span class="required">*</span> From Stage
                                                </label>
                                                <div class="col-md-3">
                                                ...
                                                <label class="col-md-1 control-label text-right">
                                                    <span class="required">*</span> To Stage
                                                </label>
                                                <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                        <ContentTemplate>
                                                            <asp:CheckBox ID="chkAll" runat="server" Visible="false" Text="All" AutoPostBack="true"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                        <ContentTemplate>
                                                            <asp:CheckBoxList ID="chkItems" CellPadding="6" RepeatColumns="2" CssClass="checker" runat="server" RepeatDirection="Vertical">
                                                            </asp:CheckBoxList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                        </Triggers>
